  ...
  <div class="app-container">
    <el-card>
      ...
      >
        ...
        <el-form-item label="方式" prop="rechargeMethod">
          <el-select v-model="queryParams.rechargeMethod" placeholder="全部" clearable style="width: 140px">
      ...
      <el-table v-loading="loading" :data="rechargeList" border>
        ...
        <el-table-column label="方式" prop="rechargeMethod" width="120">
          <template slot-scope="scope">
            {{ getMethodLabel(scope.row.rechargeMethod) }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="拒绝原因" prop="rejectReason" min-width="180">
          <template slot-scope="scope">
    ...
    <el-dialog title="充值详情" :visible.sync="detailVisible" width="700px" append-to-body>
        ...
        <el-row :gutter="12">
          ...
          <el-col :span="12">
            <el-form-item label="方式">
              <el-input :value="getMethodLabel(detailForm.rechargeMethod)" readonly />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="12">
    ...
    <el-dialog title="充值审核" :visible.sync="auditVisible" width="560px" append-to-body>
...
<script>
import { getRecharge, listRecharge, reviewRecharge } from '@/api/operation/recharge'
...
export default {
  ...
  data() {
    return {
      ...
      methodOptions: [
        { label: '人民币充值', value: 'RMB' },
        { label: 'USDT充值', value: 'USDT' }
      ],
      statusOptions: [
        { label: '待审核', value: 0 },
        { label: '已通过', value: 1 },
  ...
  methods: {
    ...
    getMethodLabel(value) {
      return String(value).toUpperCase() === 'USDT' ? 'USDT充值' : '人民币充值'
    },
    ...
    submitAudit() {
      ...
      reviewRecharge(this.auditForm).then(() => {
