...
import 'package:myapp/pages/auth/register/register_controller.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        return AuthShell(
          title: i18n.t('authRegisterTitle'),
          subtitle: i18n.t('authRegisterSubTitle'),
          child: Column(
            ...
            children: <Widget>[
              ...
              if (_controller.inviteCodeEnabled) ...<Widget>[
                const SizedBox(height: 12),
                _authField(
                  controller: _controller.inviteCodeController,
                  label: i18n.t('authInviteCode'),
                  hint: i18n.t('authInviteCodeHint'),
              ...
              FilledButton(
                ...
                style: FilledButton.styleFrom(
                  ...
                  foregroundColor: const Color(0xFF041E16),
                ),
                child: Text(
                  _controller.submitting
                      ? i18n.t('authSubmitting')
                      : i18n.t('authRegisterAction'),
                ),
              ),
  ...
  Future<void> _onSubmit() async {
    ...
    if (message == null || message.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(i18n.t('authRegisterSuccess'))),
      );
