  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      animation: Listenable.merge(<Listenable>[
        _controller,
        AppBootstrapTool.configNotifier,
      ]),
      builder: (_, __) {
        final config = AppBootstrapTool.config;
        return AuthShell(
          title: i18n.t('authLoginTitle'),
          subtitle: i18n.t('authLoginSubTitle'),
          topRight: config.multiLanguageEnabled
              ? TextButton.icon(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              FilledButton(
                onPressed: (_controller.submitting || _controller.loadingCaptcha) ? null : _onSubmit,
              ...
              Row(
                children: <Widget>[
                  TextButton(
                    onPressed: config.registerEnabled ? _goRegister : null,
              ...
              if (!config.registerEnabled)
                Padding(
                  ...
                  child: Text(
                    i18n.t('authRegisterDisabled'),
                    style: const TextStyle(color: Color(0xFF9FB3CB), fontSize: 12),
                  ),
                ),
            ],
          ),
