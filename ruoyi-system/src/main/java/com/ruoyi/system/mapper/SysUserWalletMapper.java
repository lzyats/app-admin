...
public interface SysUserWalletMapper {
     ...
     * @return 钱包信息
     */
    public SysUserWallet selectWalletByUserIdAndCurrencyType(@Param("userId") Long userId, @Param("currencyType") String currencyType);

    public SysUserWallet selectWalletByUserIdAndCurrencyTypeForUpdate(@Param("userId") Long userId, @Param("currencyType") String currencyType);
