...
) ENGINE = InnoDB AUTO_INCREMENT = 128 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_config` VALUES (4, 'APP配置-验证码开关', 'sys.account.captchaEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-04 13:42:06', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (5, 'APP配置-开放注册', 'sys.account.registerUser', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-04 13:41:41', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (101, 'APP配置-多语言开关', 'app.feature.multiLanguage', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 21:18:08', 'admin', '2026-05-04 13:42:34', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (102, 'APP配置-邀请码注册', 'app.feature.inviteCodeEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 21:18:08', 'admin', '2026-05-04 13:42:44', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (104, 'APP配置-实名认证需手持', 'app.feature.realNameHandheldRequired', 'false', 'SWITCH', 'N', '1', 'admin', '2026-04-26 13:59:38', 'admin', '2026-05-04 13:42:52', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (105, 'APP配置-美元汇率', 'app.currency.usdRate', '7', 'TEXT', 'N', '1', 'admin', '2026-04-28 22:01:40', 'admin', '2026-05-02 12:35:45', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (106, 'APP配置-投资货币方式', 'app.currency.investMode', '2', 'TEXT', 'N', '1', 'admin', '2026-04-28 22:01:48', 'admin', '2026-05-02 12:35:45', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (107, 'APP配置-支持人民币兑换美元', 'app.currency.supportRmbToUsd', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-29 16:40:02', 'admin', '2026-05-04 13:43:00', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (108, 'APP配置-签到奖励类型', 'app.sign.rewardType', 'POINT', 'SELECT', 'N', '1', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-04 13:53:37', 'POINT,MONEY');
INSERT INTO `sys_config` VALUES (109, 'APP配置-签到奖励数', 'app.sign.rewardAmount', '300', 'TEXT', 'N', '1', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-02 12:35:45', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (111, 'APP配置-余额宝必须持有24小时后才能赎回', 'app.yebao.redeemAfter24h', 'true', 'SWITCH', 'N', '1', 'admin', '2026-05-01 01:10:00', 'admin', '2026-05-04 13:53:54', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (113, 'APP配置-邀请返佣规则', 'app.invite.rewardRule', '[]', 'TEXT', 'N', '1', 'admin', '2026-05-01 17:15:21', 'admin', '2026-05-02 12:35:45', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (118, 'APP配置-矿机收益模式', 'app.miner.rewardMode', 'AUTO', 'SELECT', 'N', '1', 'admin', '2026-05-02 17:01:40', 'admin', '2026-05-04 14:07:36', 'AUTO,MANUAL');
INSERT INTO `sys_config` VALUES (119, 'APP配置-WAG兑换USD汇率', 'app.miner.wagToUsdRate', '0.001', 'TEXT', 'N', '1', 'admin', '2026-05-02 17:01:40', 'admin', '2026-05-02 17:01:40', '1 WAG 可兑换 USD 数量，单币种模式下将换算为人民币');
INSERT INTO `sys_config` VALUES (120, 'APP配置-余额宝收益等级加成开关', 'app.yebao.levelBonusEnabled', 'false', 'SWITCH', 'N', '1', 'admin', '2026-05-03 19:22:49', 'admin', '2026-05-04 13:56:29', '为 true 时：余额宝结算收益按用户等级 invest_bonus(%) 加成');
...
INSERT INTO `sys_config` VALUES (125, '合同公章1', 'app.htimg1', 'https://img.1trx.in/avatar/e9db4cd527cc48769a5f0b8550af2037.png', 'IMAGE', 'N', '1', 'admin', '2026-05-04 14:09:05', '', NULL, NULL);
INSERT INTO `sys_config` VALUES (126, 'APP合同公章2', 'app.htimg2', 'https://img.1trx.in/avatar/8146ff520faf44ba93504800130a374c.png', 'IMAGE', 'N', '1', 'admin', '2026-05-04 14:09:39', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资合同签署记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资订单' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_invest_order
-- ----------------------------
INSERT INTO `sys_invest_order` VALUES (1, 'IO202605041555361000107', 'REQ_S_1_100000_1777881335522503', 1000107, 'nnd1', 1, '人民币日息体验', 'CNY', '0', 1000.00, 1.0000, 1.2000, 1.0000, 1, 0.020000, 'IC202605041555361000107', '2', 'nnd1', '2026-05-04 15:55:36', 'admin', '2026-05-04 18:27:45', '后台赎回，仅退还本金');
INSERT INTO `sys_invest_order` VALUES (2, 'IO202605041650241000107', 'REQ_S_2_20000_1777884623635719', 1000107, 'nnd1', 2, 'USD日息体验', 'USD', '0', 200.00, 1.0000, 1.2000, 1.0000, 1, 0.000000, 'IC202605041650241000107', '2', 'nnd1', '2026-05-04 16:50:24', 'admin', '2026-05-04 18:27:49', '后台赎回，仅退还本金');
INSERT INTO `sys_invest_order` VALUES (3, 'IO202605041834391000107', 'REQ_S_1_100000_1777890878541305', 1000107, 'nnd1', 1, '人民币日息体验', 'CNY', '0', 1000.00, 1.0000, 1.2000, 1.0000, 1, 10.000000, 'IC202605041834391000107', '2', 'nnd1', '2026-05-04 18:34:39', 'admin', '2026-05-04 19:22:32', '后台赎回，仅退还本金');
INSERT INTO `sys_invest_order` VALUES (4, 'IO202605041936261000107', 'REQ_S_1_100000_1777894585302216', 1000107, 'nnd1', 1, '人民币日息体验', 'CNY', '0', 1000.00, 1.0000, 1.2000, 1.0000, 1, 10.000000, 'IC202605041936261000107', '2', 'nnd1', '2026-05-04 19:36:26', 'admin', '2026-05-04 19:41:07', '后台赎回，仅退还本金');
INSERT INTO `sys_invest_order` VALUES (5, 'IO202605041957471000107', 'REQ_S_1_100000_1777895865304454', 1000107, 'nnd1', 1, '人民币日息体验', 'CNY', '0', 1000.00, 1.0000, 1.2000, 1.0000, 1, 10.000000, 'IC202605041957471000107', '1', 'nnd1', '2026-05-04 19:57:47', 'admin', '2026-05-04 21:31:11', '后台强制结算完成');
INSERT INTO `sys_invest_order` VALUES (6, 'IO202605042204251000107', 'REQ_S_2_100000_1777903464954438', 1000107, 'nnd1', 2, 'USD日息体验', 'USD', '0', 1000.00, 1.0000, 1.2000, 1.0000, 1, 10.000000, 'IC202605042204251000107', '0', 'nnd1', '2026-05-04 22:04:25', '', NULL, 'APP在线签约认购');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资订单收益计划' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资产品' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资产品标签关联' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 266 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 53 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 494 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', NULL, '00', 'ry@163.com', '15888888888', '1', NULL, '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-04 14:44:18', '2026-04-24 11:27:59', 'admin', '2026-04-24 11:27:59', '', '2026-05-04 14:44:17', '管理员', 'ABCDEF', '0', 0, 0, NULL, -1, 'CNY', 0, 0.00, 0.00, 0, 0);
...
INSERT INTO `sys_user` VALUES (1000107, NULL, 'nnd1', '小天', 'xtsd', '00', 'c@qq.com', '13988888887', '0', '1995-05-01', 'https://img.1trx.in/avatar/b06c80c1b0f349d1a94fc617bdd630e8.png', '$2a$10$/CCCtZY0SFw.qCK5aKGrf.GtezC94R565l9f/MzxR1TiwSA7v.iPC', '0', '0', '192.168.140.1', '2026-05-03 21:49:08', '2026-05-02 13:12:15', '', '2026-05-02 13:12:15', 'admin', '2026-05-04 23:20:50', NULL, 'YKZQ4N', '0,1000100', 1, 2, '$2a$10$JtWd0k6ITDSxXa3reolJiuKt1f.vi2NbKDOtgf4XNFf56zk5opU4.', 3, 'CNY', 1, 8800.00, 18000.00, 8500, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户银行卡表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户积分账变表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `sys_user_wag_wallet` VALUES (1000107, 500.00000000, 500.00000000, 0.00000000, '2026-05-03 18:48:14', '2026-05-04 20:40:00');
...
INSERT INTO `sys_user_wallet` VALUES (20, 1000107, 'CNY', 0.00, 2811.20, 0.00, 0.00, 11.20, 0.00, 5000.00, 200.00, '2026-05-02 13:12:17', '2026-05-04 21:31:11');
INSERT INTO `sys_user_wallet` VALUES (21, 1000107, 'USD', 1000.00, 2000.00, 0.00, 0.00, 0.00, 0.00, 3000.00, 0.00, '2026-05-02 13:12:17', '2026-05-04 22:04:26');
...
CREATE TABLE `sys_user_wallet_log`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户账变表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_user_withdraw`  (
  ...
  INDEX `idx_user_currency`(`user_id` ASC, `currency_type` ASC) USING BTREE,
  INDEX `idx_status_submit_time`(`status` ASC, `submit_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户提现表' ROW_FORMAT = DYNAMIC;
