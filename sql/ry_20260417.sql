...
) ENGINE = InnoDB AUTO_INCREMENT = 125 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `sys_invest_product` VALUES (1, 'CN0504A', '人民币日息体验', 'CNY', 'blue', '中低风险', NULL, NULL, '新手高回报体验产品', 1.0000, 1.2000, 1, 'DAILY', 'MATURITY', 0, 0, NULL, 1000.00, 1000.00, 20000, 0, 2000.0000, 500.0000, 0.0000, '1', '0', 2, '0', 0, 1, '0', NULL, NULL, 'admin', '2026-05-04 12:58:22', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 424 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
