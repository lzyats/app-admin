...
) ENGINE = InnoDB AUTO_INCREMENT = 127 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资合同签署记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资订单' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资产品' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_invest_product
-- ----------------------------
INSERT INTO `sys_invest_product` VALUES (1, 'CN0504A', '人民币日息体验', 'CNY', 'blue', '中低风险', NULL, NULL, '新手高回报体验产品', NULL, 1.0000, 1.2000, 1, 'DAILY', 'MATURITY', 0, 0, NULL, 1000.00, 1000.00, 20000, 0, 0.0000, 2000.0000, 500.0000, 0.0000, '1', '0', 2, '0', 0, 1, '0', NULL, NULL, 'admin', '2026-05-04 12:58:22', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资产品标签关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_invest_product_tag_rel
-- ----------------------------
INSERT INTO `sys_invest_product_tag_rel` VALUES (1, 1, 1);
INSERT INTO `sys_invest_product_tag_rel` VALUES (2, 1, 2);
...
) ENGINE = InnoDB AUTO_INCREMENT = 264 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '团队统计事件流水表' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', NULL, '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-04 11:13:39', '2026-04-24 11:27:59', 'admin', '2026-04-24 11:27:59', '', '2026-05-04 11:13:38', '管理员', 'ABCDEF', '0', 0, 0, NULL, -1, 'CNY', 0, 0.00, 0.00, 0, 0);
