...
CREATE TABLE `sys_config`  (
  ...
  `config_value_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'TEXT' COMMENT '参数值类型：TEXT/IMAGE/FILE/DATE/SWITCH',
...
) ENGINE = InnoDB AUTO_INCREMENT = 132 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_config` VALUES (4, 'APP配置-验证码开关', 'sys.account.captchaEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (5, 'APP配置-开放注册', 'sys.account.registerUser', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (101, 'APP配置-多语言开关', 'app.feature.multiLanguage', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 21:18:08', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (102, 'APP配置-邀请码注册', 'app.feature.inviteCodeEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 21:18:08', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (104, 'APP配置-实名认证需手持', 'app.feature.realNameHandheldRequired', 'false', 'SWITCH', 'N', '1', 'admin', '2026-04-26 13:59:38', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (105, 'APP配置-美元汇率', 'app.currency.usdRate', '7', 'TEXT', 'N', '1', 'admin', '2026-04-28 22:01:40', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (106, 'APP配置-投资货币方式', 'app.currency.investMode', '2', 'SELECT', 'N', '1', 'admin', '2026-04-28 22:01:48', 'admin', '2026-05-05 11:59:01', '1=单币种,2=双币种');
INSERT INTO `sys_config` VALUES (107, 'APP配置-支持人民币兑换美元', 'app.currency.supportRmbToUsd', 'false', 'SWITCH', 'N', '1', 'admin', '2026-04-29 16:40:02', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (108, 'APP配置-签到奖励类型', 'app.sign.rewardType', 'POINT', 'SELECT', 'N', '1', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-05 11:58:01', 'POINT,MONEY');
INSERT INTO `sys_config` VALUES (109, 'APP配置-签到奖励数', 'app.sign.rewardAmount', '300', 'TEXT', 'N', '1', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (111, 'APP配置-余额宝必须持有24小时后才能赎回', 'app.yebao.redeemAfter24h', 'true', 'SWITCH', 'N', '1', 'admin', '2026-05-01 01:10:00', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
...
INSERT INTO `sys_config` VALUES (113, 'APP配置-邀请返佣规则', 'app.invite.rewardRule', '[]', 'TEXT', 'N', '1', 'admin', '2026-05-01 17:15:21', 'admin', '2026-05-05 11:58:01', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (118, 'APP配置-矿机收益模式', 'app.miner.rewardMode', 'AUTO', 'SELECT', 'N', '1', 'admin', '2026-05-02 17:01:40', 'admin', '2026-05-05 11:58:01', 'AUTO,MANUAL');
INSERT INTO `sys_config` VALUES (119, 'APP配置-WAG兑换USD汇率', 'app.miner.wagToUsdRate', '0', 'TEXT', 'N', '1', 'admin', '2026-05-02 17:01:40', 'admin', '2026-05-05 11:58:01', '1 WAG 可兑换 USD 数量，单币种模式下将换算为人民币');
INSERT INTO `sys_config` VALUES (120, 'APP配置-余额宝收益等级加成开关', 'app.yebao.levelBonusEnabled', 'false', 'SWITCH', 'N', '1', 'admin', '2026-05-03 19:22:49', 'admin', '2026-05-05 11:58:01', '为 true 时：余额宝结算收益按用户等级 invest_bonus(%) 加成');
...
INSERT INTO `sys_config` VALUES (125, '合同公章1', 'app.htimg1', 'https://img.1trx.in/avatar/e9db4cd527cc48769a5f0b8550af2037.png', 'IMAGE', 'N', '1', 'admin', '2026-05-04 14:09:05', 'admin', '2026-05-05 11:58:01', '后台 APP 配置管理保存');
INSERT INTO `sys_config` VALUES (126, 'APP合同公章2', 'app.htimg2', 'https://img.1trx.in/avatar/8146ff520faf44ba93504800130a374c.png', 'IMAGE', 'N', '1', 'admin', '2026-05-04 14:09:39', 'admin', '2026-05-05 11:58:01', '后台 APP 配置管理保存');
...
INSERT INTO `sys_config` VALUES (130, 'APP配置-拼团超时分钟', 'app.invest.groupExpireMinutes', '1440', 'TEXT', 'N', '1', 'admin', '2026-05-05 11:44:34', 'admin', '2026-05-05 11:58:01', '真实拼团开团后的超时时间（分钟），超时未成团自动失败并退款');
INSERT INTO `sys_config` VALUES (131, 'APP配置-真实拼团开关', 'app.invest.realGroupEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-05-05 11:45:01', 'admin', '2026-05-05 11:58:01', '为 true 时，APP 产品详情进入真实拼团下单链路；为 false 时按普通下单链路');
...
CREATE TABLE `sys_invest_contract_sign`  (
  ...
  `contract_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '合同编号',
  `order_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单号',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `product_id` bigint(20) NOT NULL COMMENT '产品ID',
  `contract_text` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '合同快照文本',
  `signature_data` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '手写签名base64',
  `agreed` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1' COMMENT '是否同意（0否1是）',
  `sign_time` datetime NULL DEFAULT NULL COMMENT '签约时间',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1' COMMENT '状态（0无效1有效）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资合同签署记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_invest_group`  (
  ...
  `group_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '拼团团号',
  `product_id` bigint(20) NOT NULL COMMENT '产品ID',
  `product_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `currency` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'CNY' COMMENT '币种',
  ...
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '状态：0拼团中 1已成团 2失败 3已关闭',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资拼团主表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_invest_order`  (
  ...
  `order_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单号',
  `client_req_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '客户端请求流水（幂等）',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `user_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户账号',
  `product_id` bigint(20) NOT NULL COMMENT '产品ID',
  `product_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品名称',
  `currency` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'CNY' COMMENT '投资币种',
  `group_mode` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '是否拼团（0否1是）',
  ...
  `invest_shares` bigint(20) NOT NULL DEFAULT 0 COMMENT '认购份数（用于拼团失败回滚）',
  `expected_income` decimal(18, 6) NOT NULL DEFAULT 0.000000 COMMENT '预计收益',
  `contract_no` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '合同编号',
  `group_id` bigint(20) NULL DEFAULT NULL COMMENT '拼团ID',
  `group_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '拼团团号',
  `group_status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '9' COMMENT '拼团状态：0拼团中 1已成团 2失败退款 9非拼团',
  `group_deadline_time` datetime NULL DEFAULT NULL COMMENT '拼团截止时间',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '状态（0持有中 1已完成 2已取消）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资订单' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资订单收益计划' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_invest_product`  (
  ...
  `cover_image` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '封面图',
  `gallery_images` varchar(4000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '产品组图(逗号分隔)',
  `product_content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '产品介绍(富文本)',
  `trade_rule_content` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '交易规则内容(按行展示)',
  `single_rate` decimal(10, 4) NOT NULL DEFAULT 0.0000 COMMENT '单购利率(%)',
  `group_rate` decimal(10, 4) NOT NULL DEFAULT 0.0000 COMMENT '拼团利率(%)',
  ...
  `invest_mode` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'SHARE' COMMENT '投资方式 SHARE按份额 AMOUNT按金额',
...
CREATE TABLE `sys_invest_tag`  (
  ...
  `tag_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'PRODUCT' COMMENT '标签类型: PRODUCT/RISK',
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '投资产品标签' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '等级体验券模板' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户等级体验券' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户成长值变动日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户充值表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_wallet` VALUES (20, 1000107, 'CNY', 2000.00, 711.20, 0.00, 100.00, 11.20, 0.00, 5000.00, 200.00, '2026-05-02 13:12:17', '2026-05-05 12:25:18');
...
CREATE TABLE `sys_user_wallet_log`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户账变表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_yebao_order` VALUES (3, 'YB1777619781831d8681461', NULL, 1000100, 'lanz', 3, 100.00, 300.00, 44.0300, 0.72, '2026-05-01 15:16:22', '2026-05-01 15:16:22', '2026-05-04 15:16:22', '0', 'lanz', '2026-05-01 15:16:22', 'system', '2026-05-03 18:47:42', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (4, 'YB17777032462914e9c57d8', NULL, 1000107, 'nnd1', 5, 100.00, 500.00, 44.0300, 0.60, '2026-05-01 14:27:26', '2026-05-01 14:27:26', '2026-05-04 14:27:26', '0', 'nnd1', '2026-05-02 14:27:26', 'system', '2026-05-03 18:47:44', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (5, 'YB1777807481691b561adf8', NULL, 1000107, 'nnd1', 10, 100.00, 1000.00, 44.0300, 0.00, '2026-05-01 19:24:42', '2026-05-01 19:24:42', '2026-05-04 19:24:42', '0', 'nnd1', '2026-05-03 19:24:42', '', NULL, 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (6, 'YB1777880155561fb815f26', 'YB_REQ_1777880154522957_1', 1000107, 'nnd1', 1, 100.00, 100.00, 44.0300, 0.00, '2026-05-04 15:35:56', '2026-05-04 15:35:56', '2026-05-05 15:35:56', '0', 'nnd1', '2026-05-04 15:35:56', '', NULL, 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (7, 'YB1777881071457311592a0', 'YB_REQ_1777881069035259_4', 1000107, 'nnd1', 4, 100.00, 400.00, 44.0300, 0.00, '2026-05-04 15:51:11', '2026-05-04 15:51:11', '2026-05-05 15:51:11', '0', 'nnd1', '2026-05-04 15:51:11', '', NULL, 'Yebao purchase');
