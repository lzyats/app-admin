...
CREATE TABLE `sys_config`  (
  ...
  `config_value` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '参数键值',
  `config_value_type` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'TEXT' COMMENT '参数值类型：TEXT/IMAGE/FILE/DATE/SWITCH',
  `config_type` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'N' COMMENT '系统内置（Y是 N否）',
  `is_app_config` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '是否APP配置（1是 0否）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  UNIQUE INDEX `ckey`(`config_key` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 132 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '参数配置表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_config
-- ----------------------------
INSERT INTO `sys_config` VALUES (1, '主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-blue', 'TEXT', 'Y', '0', 'admin', '2026-04-24 11:27:59', '', NULL, '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow');
INSERT INTO `sys_config` VALUES (2, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'TEXT', 'Y', '0', 'admin', '2026-04-24 11:27:59', '', NULL, '初始化密码 123456');
INSERT INTO `sys_config` VALUES (3, '主框架页-侧边栏主题', 'sys.index.sideTheme', 'theme-dark', 'TEXT', 'Y', '0', 'admin', '2026-04-24 11:27:59', '', NULL, '深色主题theme-dark，浅色主题theme-light');
INSERT INTO `sys_config` VALUES (4, 'APP配置-验证码开关', 'sys.account.captchaEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (5, 'APP配置-开放注册', 'sys.account.registerUser', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (6, '用户登录-黑名单列表', 'sys.login.blackIPList', '', 'TEXT', 'Y', '0', 'admin', '2026-04-24 11:27:59', '', NULL, '设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
INSERT INTO `sys_config` VALUES (7, '用户管理-初始密码修改策略', 'sys.account.initPasswordModify', '1', 'SELECT', 'Y', '0', 'admin', '2026-04-24 11:27:59', 'admin', '2026-05-04 13:51:33', '0=初始密码修改策略关闭,1=在登录时就会提醒修改密码对话框');
INSERT INTO `sys_config` VALUES (8, '用户管理-账号密码更新周期', 'sys.account.passwordValidateDays', '0', 'TEXT', 'Y', '0', 'admin', '2026-04-24 11:27:59', '', NULL, '密码更新周期（填写数字，数据初始化值为0不限制，若修改必须为大于0小于365的正整数），如果超过这个周期登录系统时，则在登录时就会提醒修改密码对话框');
INSERT INTO `sys_config` VALUES (9, '用户管理-密码字符范围', 'sys.account.chrtype', '0', 'TEXT', 'Y', '0', 'admin', '2026-04-24 11:27:59', '', NULL, '默认任意字符范围，0任意（密码可以输入任意字符），1数字（密码只能为0-9数字），2英文字母（密码只能为a-z和A-Z字母），3字母和数字（密码必须包含字母，数字）,4字母数字和特殊字符（目前支持的特殊字符包括：~!@#$%^&*()-=_+）');
INSERT INTO `sys_config` VALUES (100, 'APP配置-APP升级配置', 'app.upgrade.config', '{\n	\"appUrl\": \"https://img.1trx.in/app/0501004.apk\",\n  \"androidVersion\": \"1.0.3\",\n  \"androidApkUrl\": \"https://img.1trx.in/app/0501004.apk\",\n  \"iosVersion\": \"1.0.3\",\n  \"iosInstallUrl\": \"https://apps.apple.com/app/idxxxxxxxxx\",\n  \"forceUpgrade\": false,\n  \"releaseNote\": \"修复已知问题，优化线路稳定性\"\n}', 'TEXT', 'N', '0', 'admin', '2026-04-24 13:22:11', 'admin', '2026-05-01 22:25:27', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (101, 'APP配置-多语言开关', 'app.feature.multiLanguage', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 21:18:08', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (102, 'APP配置-邀请码注册', 'app.feature.inviteCodeEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-04-24 21:18:08', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (103, 'APP启动拉取项', 'app.bootstrap.items', 'multiLanguageEnabled,inviteCodeEnabled,realNameHandheldRequired,supportRmbToUsd,signRewardAmount,signContinuousRewardRule,yebaoRedeemAfter24h,usdRate,appDownloadUrl,registerEnabled,captchaEnabled,appUpgradeConfig,inviteRewardRule,investCurrencyMode,signRewardType', 'TEXT', 'N', '0', 'admin', '2026-04-25 14:18:44', 'admin', '2026-05-01 17:15:21', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (104, 'APP配置-实名认证需手持', 'app.feature.realNameHandheldRequired', 'false', 'SWITCH', 'N', '1', 'admin', '2026-04-26 13:59:38', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (105, 'APP配置-美元汇率', 'app.currency.usdRate', '7', 'TEXT', 'N', '1', 'admin', '2026-04-28 22:01:40', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (106, 'APP配置-投资货币方式', 'app.currency.investMode', '2', 'SELECT', 'N', '1', 'admin', '2026-04-28 22:01:48', 'admin', '2026-05-05 22:13:14', '1=单币种,2=双币种');
INSERT INTO `sys_config` VALUES (107, 'APP配置-支持人民币兑换美元', 'app.currency.supportRmbToUsd', 'false', 'SWITCH', 'N', '1', 'admin', '2026-04-29 16:40:02', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (108, 'APP配置-签到奖励类型', 'app.sign.rewardType', 'POINT', 'SELECT', 'N', '1', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-05 22:13:14', 'POINT,MONEY');
INSERT INTO `sys_config` VALUES (109, 'APP配置-签到奖励数', 'app.sign.rewardAmount', '300', 'TEXT', 'N', '1', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (110, 'APP配置-连续签到奖励规则', 'app.sign.continuousRewardRule', '[\n  {\"day\":1,\"amount\":300},\n  {\"day\":2,\"amount\":320},\n  {\"day\":3,\"amount\":350},\n  {\"day\":4,\"amount\":380},\n  {\"day\":5,\"amount\":400},\n  {\"day\":6,\"amount\":430},\n  {\"day\":7,\"amount\":466}\n]', 'TEXT', 'N', '0', 'admin', '2026-04-30 13:21:41', 'admin', '2026-05-01 22:41:45', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (111, 'APP配置-余额宝必须持有24小时后才能赎回', 'app.yebao.redeemAfter24h', 'true', 'SWITCH', 'N', '1', 'admin', '2026-05-01 01:10:00', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (112, 'APP配置-APP下载地址', 'app.download.url', 'https://img.1trx.in/app/0501004.apk', 'TEXT', 'N', '0', 'admin', '2026-05-01 17:15:21', 'admin', '2026-05-01 22:28:25', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (113, 'APP配置-邀请返佣规则', 'app.invite.rewardRule', '[]', 'TEXT', 'N', '1', 'admin', '2026-05-01 17:15:21', 'admin', '2026-05-05 22:13:14', 'APP 配置管理页面保存');
INSERT INTO `sys_config` VALUES (118, 'APP配置-矿机收益模式', 'app.miner.rewardMode', 'AUTO', 'SELECT', 'N', '1', 'admin', '2026-05-02 17:01:40', 'admin', '2026-05-05 22:13:14', 'AUTO,MANUAL');
INSERT INTO `sys_config` VALUES (119, 'APP配置-WAG兑换USD汇率', 'app.miner.wagToUsdRate', '0.001', 'TEXT', 'N', '1', 'admin', '2026-05-02 17:01:40', 'admin', '2026-05-05 22:13:14', '1 WAG 可兑换 USD 数量，单币种模式下将换算为人民币');
INSERT INTO `sys_config` VALUES (120, 'APP配置-余额宝收益等级加成开关', 'app.yebao.levelBonusEnabled', 'false', 'SWITCH', 'N', '1', 'admin', '2026-05-03 19:22:49', 'admin', '2026-05-05 22:13:14', '为 true 时：余额宝结算收益按用户等级 invest_bonus(%) 加成');
INSERT INTO `sys_config` VALUES (121, '团队统计-计算层级', 'team.stats.calc.depth', '3', 'TEXT', 'N', '0', 'admin', '2026-05-03 22:50:03', '', NULL, '夜间统计向上聚合层级，默认3');
INSERT INTO `sys_config` VALUES (122, '团队统计-夜间任务Cron', 'team.stats.calc.cron', '0 30 2 * * ?', 'TEXT', 'N', '0', 'admin', '2026-05-03 22:50:03', '', NULL, '团队统计夜间任务Cron表达式');
INSERT INTO `sys_config` VALUES (123, '团队统计-最近统计日期', 'team.stats.last.calc.date', '2026-05-02', 'TEXT', 'N', '0', 'admin', '2026-05-03 22:50:03', 'system', '2026-05-03 23:18:22', '夜间统计任务自动更新');
INSERT INTO `sys_config` VALUES (124, 'APP投资合同样本', 'app.invest.contract.template', '甲方（平台方）：投资平台\n乙方（投资者）：${investorNo}\n投资产品：${productName}\n投资金额：¥${amount}\n投资期限：${cycleDays}天\n预期收益率：${rate}%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 ${productName} 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币${amount}元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：${cycleDays} 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 ${rate}%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'TEXT', 'N', '0', 'admin', '2026-05-04 13:00:33', 'admin', '2026-05-04 15:01:56', 'APP端在线签约投资合同模板');
INSERT INTO `sys_config` VALUES (125, '合同公章1', 'app.htimg1', 'https://img.1trx.in/avatar/e9db4cd527cc48769a5f0b8550af2037.png', 'IMAGE', 'N', '1', 'admin', '2026-05-04 14:09:05', 'admin', '2026-05-05 22:13:14', '后台 APP 配置管理保存');
INSERT INTO `sys_config` VALUES (126, 'APP合同公章2', 'app.htimg2', 'https://img.1trx.in/avatar/8146ff520faf44ba93504800130a374c.png', 'IMAGE', 'N', '1', 'admin', '2026-05-04 14:09:39', 'admin', '2026-05-05 22:13:14', '后台 APP 配置管理保存');
INSERT INTO `sys_config` VALUES (127, 'Google验证发行方', 'sys.google.auth.issuer', 'RuoYiAdmin', 'TEXT', 'Y', '0', 'admin', '2026-05-04 18:49:11', '', NULL, 'Google Authenticator 显示的服务名称');
INSERT INTO `sys_config` VALUES (130, 'APP配置-拼团超时分钟', 'app.invest.groupExpireMinutes', '1440', 'TEXT', 'N', '1', 'admin', '2026-05-05 11:44:34', 'admin', '2026-05-05 22:13:14', '真实拼团开团后的超时时间（分钟），超时未成团自动失败并退款');
INSERT INTO `sys_config` VALUES (131, 'APP配置-真实拼团开关', 'app.invest.realGroupEnabled', 'true', 'SWITCH', 'N', '1', 'admin', '2026-05-05 11:45:01', 'admin', '2026-05-05 22:13:14', '为 true 时，APP 产品详情进入真实拼团下单链路；为 false 时按普通下单链路');
...
CREATE TABLE `sys_coupon_template`  (
  `coupon_id` bigint NOT NULL AUTO_INCREMENT COMMENT '优惠券模板ID',
  `coupon_name` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '名称',
  `coupon_type` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'EXPERIENCE/CASH/FULL_REDUCTION/RATE_BOOST',
  `scope_type` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'GLOBAL' COMMENT 'GLOBAL/PRODUCT',
  `product_ids_json` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '指定产品ID集合(JSON)',
  ...
  `min_experience_units` int NOT NULL DEFAULT 0 COMMENT '最小体验份数',
  `max_experience_units` int NOT NULL DEFAULT 0 COMMENT '最大体验份数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '优惠券模板' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_coupon_template
-- ----------------------------
INSERT INTO `sys_coupon_template` VALUES (1, '减满体验券', 'FULL_REDUCTION', 'GLOBAL', NULL, 1000.00, 50.00, 0.00, 0.0000, 0.00, 0, 0, 90, 0, 1, '0', 'admin', '2026-05-05 20:05:21', 'admin', '2026-05-05 22:26:16', NULL);
...
CREATE TABLE `sys_coupon_user`  (
  `user_coupon_id` bigint NOT NULL AUTO_INCREMENT COMMENT '用户券ID',
  ...
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '状态（0未使用 1已使用 2已过期 3已作废）',
  `start_time` datetime NULL DEFAULT NULL COMMENT '生效时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '失效时间',
  `used_time` datetime NULL DEFAULT NULL COMMENT '使用时间',
  `used_product_id` bigint NULL DEFAULT NULL COMMENT '使用产品ID',
  `used_order_id` bigint NULL DEFAULT NULL COMMENT '使用订单ID',
  `source_ref` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '来源引用',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户优惠券' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_coupon_user
-- ----------------------------
INSERT INTO `sys_coupon_user` VALUES (1, 1, 1000107, 'nnd1', 'MANUAL', '0', '2026-05-05 22:26:16', '2026-08-03 22:26:16', NULL, NULL, NULL, NULL, 'admin', '2026-05-05 22:26:16', '', NULL, NULL);
...
-- ----------------------------
-- Table structure for sys_invest_contract_sign
-- ----------------------------
DROP TABLE IF EXISTS `sys_invest_contract_sign`;
CREATE TABLE `sys_invest_contract_sign`  (
  `sign_id` bigint NOT NULL AUTO_INCREMENT COMMENT '签署ID',
  `contract_no` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '合同编号',
  `order_no` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '订单号',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `contract_text` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '合同快照文本',
  `signature_data` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '手写签名base64',
  `agreed` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1' COMMENT '是否同意（0否1是）',
  `sign_time` datetime NULL DEFAULT NULL COMMENT '签约时间',
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1' COMMENT '状态（0无效1有效）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  UNIQUE INDEX `uk_sys_invest_contract_no`(`contract_no` ASC) USING BTREE,
  INDEX `idx_sys_invest_contract_order_no`(`order_no` ASC) USING BTREE,
  INDEX `idx_sys_invest_contract_uid`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资合同签署记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_invest_contract_sign
-- ----------------------------
INSERT INTO `sys_invest_contract_sign` VALUES (1, 'IC202605041555361000107', 'IO202605041555361000107', 1000107, 1, '甲方（平台方）：投资平台\n乙方（投资者）：nnd1\n投资产品：人民币日息体验\n投资金额：¥1000\n投资期限：1天\n预期收益率：1%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币日息体验 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：1 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-04 15:55:36', '1', 'nnd1', '2026-05-04 15:55:36', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (2, 'IC202605041650241000107', 'IO202605041650241000107', 1000107, 2, '甲方（平台方）：投资平台\n乙方（投资者）：nnd1\n投资产品：USD日息体验\n投资金额：¥200\n投资期限：1天\n预期收益率：1%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 USD日息体验 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币200元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：1 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-04 16:50:25', '1', 'nnd1', '2026-05-04 16:50:24', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (3, 'IC202605041834391000107', 'IO202605041834391000107', 1000107, 1, '甲方（平台方）：投资平台\n乙方（投资者）：nnd1\n投资产品：人民币日息体验\n投资金额：¥1000\n投资期限：1天\n预期收益率：1%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币日息体验 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：1 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-04 18:34:40', '1', 'nnd1', '2026-05-04 18:34:39', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (4, 'IC202605041936261000107', 'IO202605041936261000107', 1000107, 1, '甲方（平台方）：投资平台\n乙方（投资者）：nnd1\n投资产品：人民币日息体验\n投资金额：¥1000\n投资期限：1天\n预期收益率：1%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币日息体验 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：1 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-04 19:36:26', '1', 'nnd1', '2026-05-04 19:36:26', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (5, 'IC202605041957471000107', 'IO202605041957471000107', 1000107, 1, '甲方（平台方）：投资平台\n乙方（投资者）：nnd1\n投资产品：人民币日息体验\n投资金额：¥1000\n投资期限：1天\n预期收益率：1%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币日息体验 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：1 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-04 19:57:47', '1', 'nnd1', '2026-05-04 19:57:47', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (6, 'IC202605042204251000107', 'IO202605042204251000107', 1000107, 2, '甲方（平台方）：投资平台\n乙方（投资者）：nnd1\n投资产品：USD日息体验\n投资金额：¥1000\n投资期限：1天\n预期收益率：1%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 USD日息体验 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：1 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-04 22:04:26', '1', 'nnd1', '2026-05-04 22:04:25', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (7, 'IC202605051222401000107', 'IO202605051222401000107', 1000107, 3, '甲方（平台方）：投资平台\n乙方（投资者）：xtsd\n投资产品：人民币定时测试\n投资金额：¥1000\n投资期限：5天\n预期收益率：1.2%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币定时测试 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：5 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1.2%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-05 12:22:41', '1', 'nnd1', '2026-05-05 12:22:41', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (8, 'IC202605051225181000107', 'IO202605051225181000107', 1000107, 3, '甲方（平台方）：投资平台\n乙方（投资者）：xtsd\n投资产品：人民币定时测试\n投资金额：¥1000\n投资期限：5天\n预期收益率：1.2%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币定时测试 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：5 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1.2%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-05 12:25:19', '1', 'nnd1', '2026-05-05 12:25:18', '', NULL, NULL);
INSERT INTO `sys_invest_contract_sign` VALUES (9, 'IC202605051327011000100', 'IO202605051327011000100', 1000100, 3, '甲方（平台方）：投资平台\n乙方（投资者）：lanz\n投资产品：人民币定时测试\n投资金额：¥1000\n投资期限：5天\n预期收益率：1.2%\n合同条款：\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\n一、投资相关约定\n投资产品：乙方自愿投资甲方推荐的 人民币定时测试 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\n投资金额：人民币1000元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\n投资期限：5 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\n预期收益：本产品预期年化收益率为 1.2%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\n二、双方权利与义务\n（一）甲方权利与义务\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\n（二）乙方权利与义务\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\n三、风险承担\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\n四、收益结算与支付\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\n五、违约责任\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\n任何一方违反本合同其他约定，需赔偿对方实际损失。\n六、其他约定\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\n（以下无正文）', 'data:image/png;base64,', '1', '2026-05-05 13:27:02', '1', 'lanz', '2026-05-05 13:27:02', '', NULL, NULL);

-- ----------------------------
-- Table structure for sys_invest_group
-- ----------------------------
DROP TABLE IF EXISTS `sys_invest_group`;
CREATE TABLE `sys_invest_group`  (
  `group_id` bigint NOT NULL AUTO_INCREMENT COMMENT '拼团ID',
  `group_no` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '拼团团号',
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `product_name` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '产品名称',
  `currency` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'CNY' COMMENT '币种',
  `initiator_user_id` bigint NOT NULL COMMENT '开团用户ID',
  `target_size` int NOT NULL DEFAULT 2 COMMENT '成团目标人数',
  `member_count` int NOT NULL DEFAULT 0 COMMENT '当前人数',
  `total_amount` decimal(18, 2) NOT NULL DEFAULT 0.00 COMMENT '累计认购金额',
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '状态：0拼团中 1已成团 2失败 3已关闭',
  `deadline_time` datetime NULL DEFAULT NULL COMMENT '截止时间',
  `success_time` datetime NULL DEFAULT NULL COMMENT '成团时间',
  `fail_time` datetime NULL DEFAULT NULL COMMENT '失败时间',
  `close_time` datetime NULL DEFAULT NULL COMMENT '关闭时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`group_id`) USING BTREE,
  UNIQUE INDEX `uk_invest_group_no`(`group_no` ASC) USING BTREE,
  INDEX `idx_invest_group_product`(`product_id` ASC) USING BTREE,
  INDEX `idx_invest_group_status_deadline`(`status` ASC, `deadline_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资拼团主表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_invest_group
-- ----------------------------
INSERT INTO `sys_invest_group` VALUES (3, 'IG202605051222411000107', 3, '人民币定时测试', 'CNY', 1000107, 3, 2, 2000.00, '1', '2026-05-06 12:22:41', '2026-05-05 13:27:02', NULL, NULL, 'APP发起拼团', 'nnd1', '2026-05-05 12:22:41', NULL, '2026-05-05 13:27:02');
INSERT INTO `sys_invest_group` VALUES (4, 'IG202605051225181000107', 3, '人民币定时测试', 'CNY', 1000107, 3, 1, 1000.00, '0', '2026-05-06 12:25:18', NULL, NULL, NULL, 'APP发起拼团', 'nnd1', '2026-05-05 12:25:18', NULL, '2026-05-05 12:25:18');

-- ----------------------------
-- Table structure for sys_invest_order
-- ----------------------------
DROP TABLE IF EXISTS `sys_invest_order`;
CREATE TABLE `sys_invest_order`  (
  `order_id` bigint NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `order_no` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '订单号',
  `client_req_no` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '客户端请求流水（幂等）',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  ...
  `currency` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'CNY' COMMENT '投资币种',
  `group_mode` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '是否拼团（0否1是）',
  ...
  `group_status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '9' COMMENT '拼团状态：0拼团中 1已成团 2失败退款 9非拼团',
  `group_deadline_time` datetime NULL DEFAULT NULL COMMENT '拼团截止时间',
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '状态（0持有中 1已完成 2已取消）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  UNIQUE INDEX `uk_sys_invest_order_no`(`order_no` ASC) USING BTREE,
  UNIQUE INDEX `uk_sys_invest_order_user_req`(`user_id` ASC, `client_req_no` ASC) USING BTREE,
  INDEX `idx_sys_invest_order_uid`(`user_id` ASC) USING BTREE,
  INDEX `idx_sys_invest_order_pid`(`product_id` ASC) USING BTREE,
  INDEX `idx_sys_invest_order_status`(`status` ASC) USING BTREE,
  INDEX `idx_invest_order_group_id`(`group_id` ASC) USING BTREE,
  INDEX `idx_invest_order_group_no`(`group_no` ASC) USING BTREE,
  INDEX `idx_invest_order_group_status`(`group_status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资订单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_invest_order_plan`  (
  ...
  `product_id` bigint NOT NULL COMMENT '产品ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `plan_type` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'INTEREST/PRINCIPAL',
  `stage_no` int NOT NULL DEFAULT 1 COMMENT '阶段号',
  ...
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '状态（0待执行 1已执行 2取消）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资订单收益计划' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_invest_order_plan
-- ----------------------------
INSERT INTO `sys_invest_order_plan` VALUES (1, 1, 1, 1000107, 'INTEREST', 1, '2026-05-05 15:55:36', 1.0000, 0.020000, '2', NULL, '2026-05-04 15:55:36', '2026-05-04 18:27:45', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (2, 1, 1, 1000107, 'PRINCIPAL', 1, '2026-05-05 15:55:36', 0.0000, 1000.000000, '2', NULL, '2026-05-04 15:55:36', '2026-05-04 18:27:45', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (3, 2, 2, 1000107, 'INTEREST', 1, '2026-05-05 16:50:25', 1.0000, 0.000000, '2', NULL, '2026-05-04 16:50:24', '2026-05-04 18:27:49', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (4, 2, 2, 1000107, 'PRINCIPAL', 1, '2026-05-05 16:50:25', 0.0000, 200.000000, '2', NULL, '2026-05-04 16:50:24', '2026-05-04 18:27:49', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (5, 3, 1, 1000107, 'INTEREST', 1, '2026-05-05 18:34:40', 1.0000, 10.000000, '2', NULL, '2026-05-04 18:34:39', '2026-05-04 19:22:32', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (6, 3, 1, 1000107, 'PRINCIPAL', 1, '2026-05-05 18:34:40', 0.0000, 1000.000000, '2', NULL, '2026-05-04 18:34:39', '2026-05-04 19:22:32', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (7, 4, 1, 1000107, 'INTEREST', 1, '2026-05-05 19:36:26', 1.0000, 10.000000, '2', NULL, '2026-05-04 19:36:26', '2026-05-04 19:41:07', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (8, 4, 1, 1000107, 'PRINCIPAL', 1, '2026-05-05 19:36:26', 0.0000, 1000.000000, '2', NULL, '2026-05-04 19:36:26', '2026-05-04 19:41:07', '后台赎回取消未执行收益计划');
INSERT INTO `sys_invest_order_plan` VALUES (9, 5, 1, 1000107, 'INTEREST', 1, '2026-05-05 19:57:47', 1.0000, 10.000000, '1', '2026-05-04 21:31:11', '2026-05-04 19:57:47', '2026-05-04 21:31:11', '后台强制结算执行');
INSERT INTO `sys_invest_order_plan` VALUES (10, 5, 1, 1000107, 'PRINCIPAL', 1, '2026-05-05 19:57:47', 0.0000, 1000.000000, '1', '2026-05-04 21:31:11', '2026-05-04 19:57:47', '2026-05-04 21:31:11', '后台强制结算执行');
INSERT INTO `sys_invest_order_plan` VALUES (11, 6, 2, 1000107, 'INTEREST', 1, '2026-05-05 22:04:26', 1.0000, 10.000000, '0', NULL, '2026-05-04 22:04:25', NULL, '到期返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (12, 6, 2, 1000107, 'PRINCIPAL', 1, '2026-05-05 22:04:26', 0.0000, 1000.000000, '0', NULL, '2026-05-04 22:04:25', NULL, '到期返本计划');
INSERT INTO `sys_invest_order_plan` VALUES (13, 7, 3, 1000107, 'INTEREST', 1, '2026-05-06 12:22:41', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:22:41', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (14, 7, 3, 1000107, 'INTEREST', 2, '2026-05-07 12:22:41', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:22:41', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (15, 7, 3, 1000107, 'INTEREST', 3, '2026-05-08 12:22:41', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:22:41', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (16, 7, 3, 1000107, 'INTEREST', 4, '2026-05-09 12:22:41', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:22:41', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (17, 7, 3, 1000107, 'INTEREST', 5, '2026-05-10 12:22:41', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:22:41', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (18, 7, 3, 1000107, 'PRINCIPAL', 1, '2026-05-10 12:22:41', 0.0000, 1000.000000, '0', NULL, '2026-05-05 12:22:41', NULL, '到期返本计划');
INSERT INTO `sys_invest_order_plan` VALUES (19, 8, 3, 1000107, 'INTEREST', 1, '2026-05-06 12:25:19', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:25:18', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (20, 8, 3, 1000107, 'INTEREST', 2, '2026-05-07 12:25:19', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:25:18', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (21, 8, 3, 1000107, 'INTEREST', 3, '2026-05-08 12:25:19', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:25:18', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (22, 8, 3, 1000107, 'INTEREST', 4, '2026-05-09 12:25:19', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:25:18', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (23, 8, 3, 1000107, 'INTEREST', 5, '2026-05-10 12:25:19', 1.5000, 3.000000, '0', NULL, '2026-05-05 12:25:18', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (24, 8, 3, 1000107, 'PRINCIPAL', 1, '2026-05-10 12:25:19', 0.0000, 1000.000000, '0', NULL, '2026-05-05 12:25:18', NULL, '到期返本计划');
INSERT INTO `sys_invest_order_plan` VALUES (25, 9, 3, 1000100, 'INTEREST', 1, '2026-05-06 13:27:02', 1.5000, 3.000000, '0', NULL, '2026-05-05 13:27:02', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (26, 9, 3, 1000100, 'INTEREST', 2, '2026-05-07 13:27:02', 1.5000, 3.000000, '0', NULL, '2026-05-05 13:27:02', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (27, 9, 3, 1000100, 'INTEREST', 3, '2026-05-08 13:27:02', 1.5000, 3.000000, '0', NULL, '2026-05-05 13:27:02', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (28, 9, 3, 1000100, 'INTEREST', 4, '2026-05-09 13:27:02', 1.5000, 3.000000, '0', NULL, '2026-05-05 13:27:02', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (29, 9, 3, 1000100, 'INTEREST', 5, '2026-05-10 13:27:02', 1.5000, 3.000000, '0', NULL, '2026-05-05 13:27:02', NULL, '按天返息计划');
INSERT INTO `sys_invest_order_plan` VALUES (30, 9, 3, 1000100, 'PRINCIPAL', 1, '2026-05-10 13:27:02', 0.0000, 1000.000000, '0', NULL, '2026-05-05 13:27:02', NULL, '到期返本计划');
...
CREATE TABLE `sys_invest_product`  (
  ...
  `product_code` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '产品编码',
  `product_name` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '产品名称',
  `currency` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'USDT' COMMENT '投资币种',
  `card_theme` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'blue' COMMENT '前端卡片主题',
  `risk_tag` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '风险标签',
  `cover_image` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '封面图',
  `gallery_images` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '产品组图(逗号分隔)',
  `product_content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '产品介绍(富文本)',
  `trade_rule_content` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交易规则内容(按行展示)',
  `single_rate` decimal(10, 4) NOT NULL DEFAULT 0.0000 COMMENT '单购利率(%)',
  `group_rate` decimal(10, 4) NOT NULL DEFAULT 0.0000 COMMENT '拼团利率(%)',
  `cycle_days` int NOT NULL DEFAULT 1 COMMENT '总周期(天)',
  `interest_mode` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'DAILY' COMMENT '返息方式 DAILY/STAGED/MATURITY',
  `principal_mode` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'MATURITY' COMMENT '返本方式 STAGED/MATURITY',
  `interest_stage_count` int NOT NULL DEFAULT 0 COMMENT '返息阶段数',
  `principal_stage_count` int NOT NULL DEFAULT 0 COMMENT '返本阶段数',
  `stage_config_json` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '分段配置JSON',
  `invest_mode` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'SHARE' COMMENT '投资方式 SHARE按份额 AMOUNT按金额',
  ...
  `total_shares` bigint NOT NULL DEFAULT 0 COMMENT '总份数',
  `sold_shares` bigint NOT NULL DEFAULT 0 COMMENT '已售份数',
  `total_amount` decimal(18, 2) NOT NULL DEFAULT 0.00 COMMENT '总金额',
  `sold_amount` decimal(18, 2) NOT NULL DEFAULT 0.00 COMMENT '已售金额',
  `progress_percent` decimal(10, 4) NOT NULL DEFAULT 0.0000 COMMENT '进度百分比',
  ...
  `coupon_enabled` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1' COMMENT '是否可用优惠券（0否1是）',
  `group_enabled` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '是否拼团（0否1是）',
  `group_size` int NOT NULL DEFAULT 2 COMMENT '成团人数',
  `auto_group` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1' COMMENT '是否自动拼团（0否1是）',
  `limit_level` int NOT NULL DEFAULT 0 COMMENT '限购等级',
  `limit_times` int NOT NULL DEFAULT 0 COMMENT '限投次数（0不限）',
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资产品' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_invest_product` VALUES (4, 'CN0504A_C576251', '人民币等级优惠测试', 'CNY', 'blue', '中低风险', NULL, NULL, '新手高回报体验产品，每人限购一单。', '本产品为到期返息产品\n产品到期后会将产生的收益和本金全部返回至用户账号\n如需提现可自行提交，系统客服会在24小时内处理提现事宜', 1.0000, 1.2000, 10, 'STAGED', 'MATURITY', 3, 0, '{\"interestStages\":[{\"stageNo\":1,\"days\":1,\"ratio\":30,\"remark\":\"\"},{\"stageNo\":2,\"days\":1,\"ratio\":30,\"remark\":\"\"},{\"stageNo\":3,\"days\":1,\"ratio\":40,\"remark\":\"\"}],\"principalStages\":[]}', 'AMOUNT', 1000.00, 50000.00, 0, 0, 20000000.00, 900000.00, 4.5000, 2000.0000, 500.0000, 0.0000, '1', '0', 2, '0', 0, 1, '0', NULL, NULL, 'admin', '2026-05-05 18:06:16', 'admin', '2026-05-05 22:33:38', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资产品标签关联' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_invest_product_tag_rel
-- ----------------------------
INSERT INTO `sys_invest_product_tag_rel` VALUES (13, 1, 1);
INSERT INTO `sys_invest_product_tag_rel` VALUES (14, 1, 2);
INSERT INTO `sys_invest_product_tag_rel` VALUES (19, 2, 1);
...
INSERT INTO `sys_invest_product_tag_rel` VALUES (49, 4, 1);
INSERT INTO `sys_invest_product_tag_rel` VALUES (50, 4, 2);
...
CREATE TABLE `sys_invest_tag`  (
  ...
  `tag_code` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '标签编码',
  `tag_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '标签名称',
  `tag_color` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '#409EFF' COMMENT '标签颜色',
  `tag_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'PRODUCT' COMMENT '标签类型: PRODUCT/RISK',
  ...
  INDEX `idx_sys_invest_tag_type`(`tag_type` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '投资产品标签' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_invest_tag
-- ----------------------------
INSERT INTO `sys_invest_tag` VALUES (1, 'NEWBIE', '新手专区', '#67C23A', 'PRODUCT', 1, '0', 'admin', '2026-05-03 21:30:27', '', NULL, '默认标签');
INSERT INTO `sys_invest_tag` VALUES (2, 'HOT', '热门投资', '#F56C6C', 'PRODUCT', 2, '0', 'admin', '2026-05-03 21:30:27', '', NULL, '默认标签');
INSERT INTO `sys_invest_tag` VALUES (3, 'GROUP', '团购专区', '#E6A23C', 'PRODUCT', 3, '0', 'admin', '2026-05-03 21:30:27', '', NULL, '默认标签');
INSERT INTO `sys_invest_tag` VALUES (4, 'DFX', '低风险', '#409EFF', 'RISK', 0, '0', 'admin', '2026-05-04 12:47:04', '', NULL, NULL);
INSERT INTO `sys_invest_tag` VALUES (5, 'ZDFX', '中低风险', '#409EFF', 'RISK', 0, '0', 'admin', '2026-05-04 12:47:20', '', NULL, NULL);
INSERT INTO `sys_invest_tag` VALUES (7, 'ZDDFX', '中度风险', '#409EFF', 'RISK', 0, '0', 'admin', '2026-05-04 12:49:38', '', NULL, NULL);
...
CREATE TABLE `sys_level_trial_template`  (
  `trial_id` bigint NOT NULL AUTO_INCREMENT COMMENT '体验券模板ID',
  `trial_name` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '名称',
...
CREATE TABLE `sys_level_trial_user`  (
  `user_trial_id` bigint NOT NULL AUTO_INCREMENT COMMENT '用户体验券ID',
  `trial_id` bigint NOT NULL COMMENT '模板ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '用户名',
  `grant_type` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'MANUAL' COMMENT '发放类型 MANUAL/LEVEL/ACTIVITY/SYSTEM',
...
INSERT INTO `sys_logininfor` VALUES (263, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-04 11:13:41');
INSERT INTO `sys_logininfor` VALUES (264, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '1', '验证码错误', '2026-05-04 14:44:13');
INSERT INTO `sys_logininfor` VALUES (265, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-04 14:44:17');
INSERT INTO `sys_logininfor` VALUES (266, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-05 10:56:14');
INSERT INTO `sys_logininfor` VALUES (267, 'lanz', '192.168.140.1', '内网IP', 'Dart 3.4', '', '0', '登录成功', '2026-05-05 13:26:21');
INSERT INTO `sys_logininfor` VALUES (268, 'nnd1', '192.168.140.1', '内网IP', 'Dart 3.4', '', '0', '登录成功', '2026-05-05 13:28:45');
INSERT INTO `sys_logininfor` VALUES (269, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-05 13:31:21');
INSERT INTO `sys_logininfor` VALUES (270, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '0', '退出成功', '2026-05-05 13:34:03');
INSERT INTO `sys_logininfor` VALUES (271, 'admin', '127.0.0.1', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-05 13:34:09');
...
INSERT INTO `sys_menu` VALUES (2018, '新闻文章', 2016, 2, 'newsArticle', 'system/news/article/index', '', '', 1, 0, 'C', '0', '0', 'system:news:article:list', 'dict', 'admin', '2026-04-30 16:39:37', 'admin', '2026-05-05 14:16:20', '新闻文章管理');
...
INSERT INTO `sys_menu` VALUES (2050, '标签管理', 2043, 7, 'investTag', 'operation/investTag/index', NULL, NULL, 1, 0, 'C', '0', '0', 'system:invest:list', 'build', 'admin', '2026-05-03 23:50:04', 'admin', '2026-05-04 00:10:17', '投资产品标签管理');
...
INSERT INTO `sys_menu` VALUES (2055, 'APP广告管理', 2016, 3, 'appAd', 'system/appAd/index', '', '', 1, 0, 'C', '0', '0', 'system:news:article:list', 'international', 'admin', '2026-05-05 14:12:27', 'admin', '2026-05-05 14:16:35', 'APP首页Banner与广告管理');
...
CREATE TABLE `sys_miner`  (
  `miner_id` bigint NOT NULL AUTO_INCREMENT COMMENT '矿机ID',
  `miner_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '矿机名称',
  `miner_level` int NOT NULL DEFAULT 0 COMMENT '矿机等级（展示用）',
  `power` int NOT NULL DEFAULT 0 COMMENT '功率（展示/计算用）',
  `wag_per_day` decimal(18, 8) NOT NULL DEFAULT 0.00000000 COMMENT '日收益WAG（24小时一轮）',
  `min_user_level` int NOT NULL DEFAULT 0 COMMENT '可领取最小用户等级（含）',
  `max_user_level` int NOT NULL DEFAULT 999 COMMENT '可领取最大用户等级（含）',
...
CREATE TABLE `sys_miner_exchange_log`  (
  `exchange_id` bigint NOT NULL AUTO_INCREMENT COMMENT '兑换日志ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '矿机WAG兑换日志' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_miner_exchange_log
-- ----------------------------
INSERT INTO `sys_miner_exchange_log` VALUES (1, 1000107, 'WAG1777949474909442705', 100.00000000, 0.00100000, 'USD', 0.10000000, '0', NULL, '2026-05-05 10:51:16', '2026-05-05 10:51:16');
INSERT INTO `sys_miner_exchange_log` VALUES (2, 1000107, 'WAG1777950204790329237', 100.00000000, 0.00100000, 'USD', 0.10000000, '0', NULL, '2026-05-05 11:03:25', '2026-05-05 11:03:25');
...
CREATE TABLE `sys_miner_reward_log`  (
  ...
  `user_miner_id` bigint NOT NULL COMMENT '用户矿机ID',
  `run_id` bigint NULL DEFAULT NULL COMMENT '运行记录ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '新闻文章表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_news_article` VALUES (5, 3, 'APP_HOME_BANNER', '首页1', NULL, 'https://img.1trx.in/avatar/b861d26a0a054056be402cb8b6fcf56a.png', NULL, 0, '0', '0', 'admin', '2026-05-05 15:05:08', '', NULL, NULL);
INSERT INTO `sys_news_article` VALUES (6, 4, 'APP_HOME_AD', '首页广告1', 'app://product/group', 'https://img.1trx.in/avatar/432003d40b294519a357d171f33c0aa8.webp', '', 0, '0', '0', 'admin', '2026-05-05 15:06:50', 'admin', '2026-05-05 15:59:03', '');
INSERT INTO `sys_news_article` VALUES (7, 4, 'APP_HOME_AD', '首页广告2', NULL, 'https://img.1trx.in/avatar/f12386d9558b4277ac5497ac90a14dab.png', NULL, 0, '0', '0', 'admin', '2026-05-05 15:09:47', '', NULL, NULL);
INSERT INTO `sys_news_article` VALUES (8, 4, 'APP_HOME_AD', '首页广告3', NULL, 'https://img.1trx.in/avatar/f1c4ff1a6bfe40a1b786cc65a1fcfaf4.webp', NULL, 0, '0', '0', 'admin', '2026-05-05 15:58:48', '', NULL, NULL);
...
CREATE TABLE `sys_news_category`  (
  ...
  `category_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'NEWS' COMMENT '分类类型：NEWS/APP_HOME_BANNER/APP_HOME_AD',
  `sort_order` int NOT NULL DEFAULT 0 COMMENT '排序',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
  `create_by` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '新闻分类表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_news_category
-- ----------------------------
INSERT INTO `sys_news_category` VALUES (1, 'NEWS_INFO', '新闻资讯', 'NEWS', 1, '0', 'admin', '2026-04-30 16:35:07', '', NULL, '默认新闻资讯分类');
INSERT INTO `sys_news_category` VALUES (2, 'COMPANY_INFO', '公司信息', 'NEWS', 2, '0', 'admin', '2026-04-30 16:35:07', '', NULL, '默认公司信息分类');
INSERT INTO `sys_news_category` VALUES (3, 'APP_HOME_BANNER', 'APP首页Banner', 'APP_HOME_BANNER', 10, '0', 'admin', '2026-05-05 14:12:27', '', NULL, 'APP首页Banner管理');
INSERT INTO `sys_news_category` VALUES (4, 'APP_HOME_AD', 'APP首页广告', 'APP_HOME_AD', 11, '0', 'admin', '2026-05-05 14:12:27', '', NULL, 'APP首页广告管理');
...
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '通知公告表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_notice` VALUES (42, '充值申请待审核', '3', 0xE794A8E688B7206E6E643120E68F90E4BAA4E4BA86E4B880E7AC94E58585E580BCE794B3E8AFB7EFBC8CE98791E9A29D20323030302E3030E38082, '0', 'system', '2026-05-04 19:52:48', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (43, '充值审核通过', '3', 0xE794A8E688B7206E6E643120E79A84E58585E580BCE8AEA2E58D952052433230323630353034313935323438374230343138373220E5B7B2E9809AE8BF87E5AEA1E6A0B8E38082E98791E9A29D20323030302E303020434E5920E5B7B2E588B0E8B4A6E38082, '0', 'system', '2026-05-04 19:53:48', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (44, '提现申请待审核', '3', 0xE794A8E688B7206E6E643120E68F90E4BAA4E4BA86E4B880E7AC94E68F90E78EB0E794B3E8AFB7EFBC8CE98791E9A29D203230302E303020E4BABAE6B091E5B881E38082, '0', 'system', '2026-05-04 20:32:40', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (45, '提现审核通过', '3', 0xE794A8E688B7206C616E7A20E79A84E68F90E78EB0E8AEA2E58D952057443230323630343239323130333532454443353739444120E5B7B2E5AEA1E6A0B8E9809AE8BF87EFBC8CE98791E9A29D203130302E3030205553445420E5B7B2E5AE8CE68890E5A484E79086E38082, '0', 'system', '2026-05-04 20:36:01', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (46, '提现审核通过', '3', 0xE794A8E688B7206E6E643120E79A84E68F90E78EB0E8AEA2E58D952057443230323630353034323033323339353833313637334320E5B7B2E5AEA1E6A0B8E9809AE8BF87EFBC8CE98791E9A29D203230302E303020E4BABAE6B091E5B88120E5B7B2E5AE8CE68890E5A484E79086E38082, '0', 'system', '2026-05-04 20:36:34', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (47, '实名认证待审核', '3', 0xE794A8E688B7206E756C6CEFBC88E8B4A6E58FB7EFBC9A6E6E6431EFBC89E68F90E4BAA4E4BA86E5AE9EE5908DE8AEA4E8AF81E794B3E8AFB7E38082, '0', 'system', '2026-05-04 23:12:59', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (48, '实名认证待审核', '3', 0xE794A8E688B7206E756C6CEFBC88E8B4A6E58FB7EFBC9A6E6E6431EFBC89E68F90E4BAA4E4BA86E5AE9EE5908DE8AEA4E8AF81E794B3E8AFB7E38082, '0', 'system', '2026-05-04 23:20:46', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (49, '提现申请待审核', '3', 0xE794A8E688B7206E6E643120E68F90E4BAA4E4BA86E4B880E7AC94E68F90E78EB0E794B3E8AFB7EFBC8CE98791E9A29D203130302E303020E4BABAE6B091E5B881E38082, '0', 'system', '2026-05-05 11:04:40', '', NULL, NULL);
INSERT INTO `sys_notice` VALUES (50, '充值申请待审核', '3', 0xE794A8E688B7206E6E643120E68F90E4BAA4E4BA86E4B880E7AC94E58585E580BCE794B3E8AFB7EFBC8CE98791E9A29D203135303030302E3030E38082, '0', 'system', '2026-05-05 22:21:14', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '公告已读记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_notice_read` VALUES (38, 46, 1, '2026-05-04 23:05:13');
INSERT INTO `sys_notice_read` VALUES (39, 45, 1, '2026-05-04 23:05:13');
INSERT INTO `sys_notice_read` VALUES (40, 44, 1, '2026-05-04 23:05:13');
INSERT INTO `sys_notice_read` VALUES (41, 43, 1, '2026-05-04 23:05:13');
INSERT INTO `sys_notice_read` VALUES (42, 42, 1, '2026-05-04 23:05:13');
INSERT INTO `sys_notice_read` VALUES (43, 47, 1, '2026-05-04 23:20:24');
INSERT INTO `sys_notice_read` VALUES (48, 48, 1, '2026-05-04 23:20:57');
INSERT INTO `sys_notice_read` VALUES (50, 49, 1, '2026-05-05 13:32:07');
INSERT INTO `sys_notice_read` VALUES (55, 50, 1, '2026-05-05 22:48:16');
...
INSERT INTO `sys_oper_log` VALUES (416, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"operation/investTag/index\",\"createTime\":\"2026-05-03 23:50:04\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2050,\"menuName\":\"标签管理\",\"menuType\":\"C\",\"orderNum\":5,\"params\":{},\"parentId\":2043,\"path\":\"investTag\",\"perms\":\"system:invest:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 00:09:17', 24);
INSERT INTO `sys_oper_log` VALUES (417, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"operation/investTag/index\",\"createTime\":\"2026-05-03 23:50:04\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2050,\"menuName\":\"标签管理\",\"menuType\":\"C\",\"orderNum\":5,\"params\":{},\"parentId\":2043,\"path\":\"investTag\",\"perms\":\"system:invest:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 00:09:49', 8);
INSERT INTO `sys_oper_log` VALUES (418, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"operation/investTag/index\",\"createTime\":\"2026-05-03 23:50:04\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2050,\"menuName\":\"标签管理\",\"menuType\":\"C\",\"orderNum\":7,\"params\":{},\"parentId\":2043,\"path\":\"investTag\",\"perms\":\"system:invest:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 00:10:17', 20);
INSERT INTO `sys_oper_log` VALUES (419, '投资产品标签', 1, 'com.ruoyi.web.controller.system.SysInvestTagController.add()', 'POST', 1, 'admin', NULL, '/system/invest/tag', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"params\":{},\"sortOrder\":0,\"status\":\"0\",\"tagCode\":\"DFX\",\"tagColor\":\"#409EFF\",\"tagId\":4,\"tagName\":\"低风险\",\"tagType\":\"RISK\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 12:47:04', 113);
INSERT INTO `sys_oper_log` VALUES (420, '投资产品标签', 1, 'com.ruoyi.web.controller.system.SysInvestTagController.add()', 'POST', 1, 'admin', NULL, '/system/invest/tag', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"params\":{},\"sortOrder\":0,\"status\":\"0\",\"tagCode\":\"ZDFX\",\"tagColor\":\"#409EFF\",\"tagId\":5,\"tagName\":\"中低风险\",\"tagType\":\"RISK\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 12:47:20', 67);
INSERT INTO `sys_oper_log` VALUES (421, '投资产品标签', 1, 'com.ruoyi.web.controller.system.SysInvestTagController.add()', 'POST', 1, 'admin', NULL, '/system/invest/tag', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"params\":{},\"sortOrder\":0,\"status\":\"0\",\"tagCode\":\"ZDFX\",\"tagColor\":\"#409EFF\",\"tagName\":\"中度风险\",\"tagType\":\"RISK\"} ', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLIntegrityConstraintViolationException: Duplicate entry \'ZDFX\' for key \'uk_sys_invest_tag_code\'\r\n### The error may exist in file [E:\\Go\\go-api\\ruoyi-system\\target\\classes\\mapper\\system\\SysInvestTagMapper.xml]\r\n### The error may involve com.ruoyi.system.mapper.SysInvestTagMapper.insertInvestTag-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into sys_invest_tag(tag_code, tag_name, tag_color, tag_type, sort_order, status, create_by, create_time, remark)         values (?, ?, ?, ?, ?, ?, ?, now(), ?)\r\n### Cause: java.sql.SQLIntegrityConstraintViolationException: Duplicate entry \'ZDFX\' for key \'uk_sys_invest_tag_code\'\n; Duplicate entry \'ZDFX\' for key \'uk_sys_invest_tag_code\'', '2026-05-04 12:49:17', 186);
INSERT INTO `sys_oper_log` VALUES (422, '投资产品标签', 1, 'com.ruoyi.web.controller.system.SysInvestTagController.add()', 'POST', 1, 'admin', NULL, '/system/invest/tag', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"params\":{},\"sortOrder\":0,\"status\":\"0\",\"tagCode\":\"ZDDFX\",\"tagColor\":\"#409EFF\",\"tagId\":7,\"tagName\":\"中度风险\",\"tagType\":\"RISK\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 12:49:38', 10);
INSERT INTO `sys_oper_log` VALUES (423, '投资产品', 1, 'com.ruoyi.web.controller.system.SysInvestProductController.add()', 'POST', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"DAILY\",\"interestStageCount\":0,\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A\",\"productContent\":\"新手高回报体验产品\",\"productId\":1,\"productName\":\"人民币日息体验\",\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalShares\":20000} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 12:58:22', 48);
INSERT INTO `sys_oper_log` VALUES (424, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":5,\"configKey\":\"sys.account.registerUser\",\"configName\":\"APP配置-开放注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:37:37', 15141);
INSERT INTO `sys_oper_log` VALUES (425, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":5,\"configKey\":\"sys.account.registerUser\",\"configName\":\"APP配置-开放注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:37:38', 14133);
INSERT INTO `sys_oper_log` VALUES (426, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":5,\"configKey\":\"sys.account.registerUser\",\"configName\":\"APP配置-开放注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:37:44', 14359);
INSERT INTO `sys_oper_log` VALUES (427, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":5,\"configKey\":\"sys.account.registerUser\",\"configName\":\"APP配置-开放注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:37:30\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:38:04', 15756);
INSERT INTO `sys_oper_log` VALUES (428, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":5,\"configKey\":\"sys.account.registerUser\",\"configName\":\"APP配置-开放注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:37:48\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:38:38', 13625);
INSERT INTO `sys_oper_log` VALUES (429, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":5,\"configKey\":\"sys.account.registerUser\",\"configName\":\"APP配置-开放注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:37:48\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:41:41', 58);
INSERT INTO `sys_oper_log` VALUES (430, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":4,\"configKey\":\"sys.account.captchaEnabled\",\"configName\":\"APP配置-验证码开关\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:42:06', 96);
INSERT INTO `sys_oper_log` VALUES (431, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":101,\"configKey\":\"app.feature.multiLanguage\",\"configName\":\"APP配置-多语言开关\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 21:18:08\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:42:34', 92);
INSERT INTO `sys_oper_log` VALUES (432, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":102,\"configKey\":\"app.feature.inviteCodeEnabled\",\"configName\":\"APP配置-邀请码注册\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 21:18:08\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:42:44', 81);
INSERT INTO `sys_oper_log` VALUES (433, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":104,\"configKey\":\"app.feature.realNameHandheldRequired\",\"configName\":\"APP配置-实名认证需手持\",\"configType\":\"N\",\"configValue\":\"false\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-26 13:59:38\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:42:53', 52);
INSERT INTO `sys_oper_log` VALUES (434, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":107,\"configKey\":\"app.currency.supportRmbToUsd\",\"configName\":\"APP配置-支持人民币兑换美元\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-04-29 16:40:02\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:43:00', 63);
INSERT INTO `sys_oper_log` VALUES (435, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":7,\"configKey\":\"sys.account.initPasswordModify\",\"configName\":\"用户管理-初始密码修改策略\",\"configType\":\"Y\",\"configValue\":\"0：初始密码修改策略关闭\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"0:初始密码修改策略关闭，没有任何提示;1:提醒用户，如果未修改初始密码，则在登录时就会提醒修改密码对话框\",\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:50:20', 25);
INSERT INTO `sys_oper_log` VALUES (436, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":7,\"configKey\":\"sys.account.initPasswordModify\",\"configName\":\"用户管理-初始密码修改策略\",\"configType\":\"Y\",\"configValue\":\"0：初始密码修改策略关闭\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"0:初始密码修改策略关闭;1:在登录时就会提醒修改密码对话框\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:50:20\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:50:52', 50);
INSERT INTO `sys_oper_log` VALUES (437, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":7,\"configKey\":\"sys.account.initPasswordModify\",\"configName\":\"用户管理-初始密码修改策略\",\"configType\":\"Y\",\"configValue\":\"1\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"0:初始密码修改策略关闭;1:在登录时就会提醒修改密码对话框\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:50:52\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:51:00', 24);
INSERT INTO `sys_oper_log` VALUES (438, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":7,\"configKey\":\"sys.account.initPasswordModify\",\"configName\":\"用户管理-初始密码修改策略\",\"configType\":\"Y\",\"configValue\":\"1\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-24 11:27:59\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"0=初始密码修改策略关闭,1=在登录时就会提醒修改密码对话框\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:51:00\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:51:33', 15);
INSERT INTO `sys_oper_log` VALUES (439, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":108,\"configKey\":\"app.sign.rewardType\",\"configName\":\"APP配置-签到奖励类型\",\"configType\":\"N\",\"configValue\":\"APP 配置管理页面保存\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-30 13:21:41\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"POINT,MONEY\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:53:25', 32);
INSERT INTO `sys_oper_log` VALUES (440, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":108,\"configKey\":\"app.sign.rewardType\",\"configName\":\"APP配置-签到奖励类型\",\"configType\":\"N\",\"configValue\":\"POINT\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-30 13:21:41\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"POINT,MONEY\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:53:25\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:53:37', 23);
INSERT INTO `sys_oper_log` VALUES (441, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":111,\"configKey\":\"app.yebao.redeemAfter24h\",\"configName\":\"APP配置-余额宝必须持有24小时后才能赎回\",\"configType\":\"N\",\"configValue\":\"true\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-05-01 01:10:00\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"APP 配置管理页面保存\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 12:35:45\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:53:54', 52);
INSERT INTO `sys_oper_log` VALUES (442, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":114,\"configKey\":\"app.miner.rewardMode\",\"configName\":\"矿机收益模式\",\"configType\":\"N\",\"configValue\":\"AUTO\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-05-02 16:01:23\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"AUTO,MANUAL\",\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:54:14', 51);
INSERT INTO `sys_oper_log` VALUES (443, '参数管理', 3, 'com.ruoyi.web.controller.system.SysConfigController.remove()', 'DELETE', 1, 'admin', NULL, '/system/config/116', '127.0.0.1', '内网IP', '[116] ', NULL, 1, '内置参数【app.miner.rewardMode】不能删除', '2026-05-04 13:54:28', 7);
INSERT INTO `sys_oper_log` VALUES (444, '参数管理', 9, 'com.ruoyi.web.controller.system.SysConfigController.refreshCache()', 'DELETE', 1, 'admin', NULL, '/system/config/refreshCache', '127.0.0.1', '内网IP', '', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:55:12', 12099);
INSERT INTO `sys_oper_log` VALUES (445, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":118,\"configKey\":\"app.miner.rewardMode\",\"configName\":\"APP配置-矿机收益模式\",\"configType\":\"N\",\"configValue\":\"AUTO\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-05-02 17:01:40\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"AUTO=自动领取,MANUAL=手工领取\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 17:01:40\"} ', '{\"msg\":\"修改参数\'APP配置-矿机收益模式\'失败，参数键名已存在\",\"code\":500}', 0, NULL, '2026-05-04 13:55:51', 2);
INSERT INTO `sys_oper_log` VALUES (446, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":118,\"configKey\":\"app.miner.rewardMode\",\"configName\":\"APP配置-矿机收益模式\",\"configType\":\"N\",\"configValue\":\"AUTO\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-05-02 17:01:40\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"AUTO=自动领取,MANUAL=手工领取\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-02 17:01:40\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:56:18', 22);
INSERT INTO `sys_oper_log` VALUES (447, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":120,\"configKey\":\"app.yebao.levelBonusEnabled\",\"configName\":\"APP配置-余额宝收益等级加成开关\",\"configType\":\"N\",\"configValue\":\"false\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-05-03 19:22:49\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"为 true 时：余额宝结算收益按用户等级 invest_bonus(%) 加成\",\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 13:56:29', 9);
INSERT INTO `sys_oper_log` VALUES (448, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":124,\"configKey\":\"app.invest.contract.template\",\"configName\":\"APP投资合同样本\",\"configType\":\"N\",\"configValue\":\"甲方（投资者）：${investorNo}\\n乙方（平台方）：投资平台\\n投资产品：${productName}\\n投资金额：¥${amount}\\n投资期限：${cycleDays}天\\n预期收益率：${rate}%\\n\\n合同条款：\\n鉴于甲方自愿通过乙方运营的投资平台，投资乙方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\\n一、投资相关约定\\n投资产品：甲方自愿投资乙方推荐的 ${productName} 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以乙方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\\n投资金额：人民币\\n元\\n（\\n大\\n写\\n：\\n{amountCN}），该金额为甲方实际投入资金，不包含任何手续费、服务费。\\n投资期限：${cycleDays} 天，自甲方资金足额转入乙方指定监管账户之日起计算，至期限届满当日终止。\\n预期收益：本产品预期年化收益率为 ${rate}%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\\n二、双方权利与义务\\n（一）甲方权利与义务\\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，乙方需予以配合。\\n需按时足额将投资资金转入乙方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（乙方同意除外）。\\n配合乙方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\\n（二）乙方权利与义务\\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\\n及时公示产品运作情况、资金使用进度及收益结算信息，接受甲方合理查询。\\n建立风险防控体系，尽力保障甲方投资资金安全，按本合同约定及时结算并支付本金及收益。\\n充分揭示投资风险，包括市场风险、政策风险等，确保甲方知晓并自愿承担相关风险。\\n三、风险承担\\n甲方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\\n因乙方故意或重大过失导致甲方资金损失的，乙方承担相应赔偿责任；因甲方自身原因（资金来源违法、逾期支付等）导致的损失，由甲方自行承担。\\n四、收益结算与支付\\n投资期限届满后 3 个工作日内，乙方完成本金及收益结算，一次性支付至甲方指定银行账户。\\n若甲方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由甲方自行承担或按双方约定分配。\\n五、违约责任\\n甲方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，乙方有权扣除已产生的收益。\\n乙方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿甲方实际损失。\\n任何一方违反本合同其他约定，需赔偿对方实际损失。\\n六、其他约定\\n本合同自甲方签字、乙方盖章之日起生效，有效期至本金及收益全部结清之日止。\\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\\n双方因履行本合同产生的争议，协商不成的，向乙方所在地有管辖权的人民法院提起诉讼。\\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\",\"configValueType\":\"TEXT\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 13:00:33\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"APP端在线签约投资合同模板\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:00:33\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:07:15', 77);
INSERT INTO `sys_oper_log` VALUES (449, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":118,\"configKey\":\"app.miner.rewardMode\",\"configName\":\"APP配置-矿机收益模式\",\"configType\":\"N\",\"configValue\":\"AUTO\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-05-02 17:01:40\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"AUTO,MANUAL\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 13:56:17\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:07:36', 12);
INSERT INTO `sys_oper_log` VALUES (450, '参数管理', 1, 'com.ruoyi.web.controller.system.SysConfigController.add()', 'POST', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configKey\":\"app.htimg1\",\"configName\":\"合同公章1\",\"configType\":\"N\",\"configValue\":\"https://img.1trx.in/avatar/e9db4cd527cc48769a5f0b8550af2037.png\",\"configValueType\":\"IMAGE\",\"createBy\":\"admin\",\"isAppConfig\":\"1\",\"params\":{}} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:09:05', 21);
INSERT INTO `sys_oper_log` VALUES (451, '参数管理', 1, 'com.ruoyi.web.controller.system.SysConfigController.add()', 'POST', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configKey\":\"app.htimg2\",\"configName\":\"APP合同公章2\",\"configType\":\"N\",\"configValue\":\"https://img.1trx.in/avatar/8146ff520faf44ba93504800130a374c.png\",\"configValueType\":\"IMAGE\",\"createBy\":\"admin\",\"isAppConfig\":\"1\",\"params\":{}} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:09:39', 33);
INSERT INTO `sys_oper_log` VALUES (452, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 12:58:22\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":1,\"productName\":\"人民币日息体验\",\"progressPercent\":0,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:34:01', 122);
INSERT INTO `sys_oper_log` VALUES (453, '投资产品', 1, 'com.ruoyi.web.controller.system.SysInvestProductController.copy()', 'POST', 1, 'admin', NULL, '/system/invest/product/copy/1', '127.0.0.1', '内网IP', '1 ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:44:40', 68);
INSERT INTO `sys_oper_log` VALUES (454, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"purple\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 14:44:40\",\"currency\":\"USD\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C80609\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":2,\"productName\":\"USD日息体验\",\"progressPercent\":0,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 14:45:03', 107);
INSERT INTO `sys_oper_log` VALUES (455, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":124,\"configKey\":\"app.invest.contract.template\",\"configName\":\"APP投资合同样本\",\"configType\":\"N\",\"configValue\":\"甲方（平台方）：投资平台\\n乙方（投资者）：${investorNo}\\n投资产品：${productName}\\n投资金额：¥${amount}\\n投资期限：${cycleDays}天\\n预期收益率：${rate}%\\n合同条款：\\n鉴于乙方自愿通过甲方运营的投资平台，投资甲方推荐的指定产品，双方本着平等自愿、公平诚信、权责对等的原则，经友好协商，订立本合同，以资共同信守履行。\\n一、投资相关约定\\n投资产品：乙方自愿投资甲方推荐的 ${productName} 产品（以下简称 “本产品”），本产品为【固定收益类 / 浮动收益类】，具体细节以甲方平台公示的产品说明书为准，该说明书为本合同不可分割的组成部分。\\n投资金额：人民币${amount}元，该金额为乙方实际投入资金，不包含任何手续费、服务费。\\n投资期限：${cycleDays} 天，自乙方资金足额转入甲方指定监管账户之日起计算，至期限届满当日终止。\\n预期收益：本产品预期年化收益率为 ${rate}%，收益计算方式为：投资收益 = 投资本金 × 预期年化收益率 × 投资期限 ÷365，固定收益类产品按约定收益率足额支付，浮动收益类产品按实际结算金额为准。\\n二、双方权利与义务\\n（一）甲方权利与义务\\n严格按照产品说明书运作投资资金，不得擅自改变资金用途、挪用投资资金。\\n及时公示产品运作情况、资金使用进度及收益结算信息，接受乙方合理查询。\\n建立风险防控体系，尽力保障乙方投资资金安全，按本合同约定及时结算并支付本金及收益。\\n充分揭示投资风险，包括市场风险、政策风险等，确保乙方知晓并自愿承担相关风险。\\n（二）乙方权利与义务\\n有权按时收取投资本金及收益，查询本产品运作情况、资金使用情况，甲方需予以配合。\\n需按时足额将投资资金转入甲方指定监管账户，不得逾期支付；承诺投资资金来源合法，无任何权属纠纷。\\n自愿承担投资风险，不得提前撤回资金、不得转让或质押本合同项下的投资权益（甲方同意除外）。\\n配合甲方完成相关信息登记，及时提供合法有效的银行账户用于收益结算。\\n三、风险承担\\n乙方充分知晓投资有风险，自愿承担因市场波动、政策调整等导致的收益减少或本金亏损。\\n因不可抗力（自然灾害、政策调整等不可预见因素）导致合同无法履行的，双方互不承担违约责任，风险共担。\\n因甲方故意或重大过失导致乙方资金损失的，甲方承担相应赔偿责任；因乙方自身原因（资金来源违法、逾期支付等）导致的损失，由乙方自行承担。\\n四、收益结算与支付\\n投资期限届满后 3 个工作日内，甲方完成本金及收益结算，一次性支付至乙方指定银行账户。\\n若乙方逾期支付投资资金，收益自资金足额到账之日起计算，逾期期间不计付收益，同时需按逾期金额的 0.05%/ 日支付违约金。\\n浮动收益类产品，实际收益与预期收益存在差异的，差额部分由乙方自行承担或按双方约定分配。\\n五、违约责任\\n乙方提前撤回资金、转让投资权益或逾期支付投资资金的，需支付投资本金 5% 的违约金，甲方有权扣除已产生的收益。\\n甲方擅自改变资金用途、逾期支付本金及收益的，按应付未付金额的 0.05%/ 日支付违约金，足额赔偿乙方实际损失。\\n任何一方违反本合同其他约定，需赔偿对方实际损失。\\n六、其他约定\\n本合同自乙方签字、甲方盖章之日起生效，有效期至本金及收益全部结清之日止。\\n本合同未尽事宜，双方可签订补充协议，补充协议与本合同具有同等法律效力。\\n双方因履行本合同产生的争议，协商不成的，向甲方所在地有管辖权的人民法院提起诉讼。\\n本合同一式两份，甲乙双方各执一份，具有同等法律效力。\\n（以下无正文）\",\"configValueType\":\"TEXT\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 13:00:33\",\"isAppConfig\":\"0\",\"params\":{},\"remark\":\"APP端在线签约投资合同模板\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 14:07:15\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 15:01:56', 54);
INSERT INTO `sys_oper_log` VALUES (456, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 12:58:22\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":1,\"productName\":\"人民币日息体验\",\"progressPercent\":0,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 14:34:00\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 15:30:30', 111);
INSERT INTO `sys_oper_log` VALUES (457, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 12:58:22\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":1,\"productName\":\"人民币日息体验\",\"progressPercent\":0.01,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":1000.00,\"soldShares\":2000,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 15:55:36\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 16:22:15', 97);
INSERT INTO `sys_oper_log` VALUES (458, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 12:58:22\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":1,\"productName\":\"人民币日息体验\",\"progressPercent\":10.0250,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":1000.00,\"soldShares\":2005,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 16:22:15\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 16:26:06', 111);
INSERT INTO `sys_oper_log` VALUES (459, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"purple\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 14:44:40\",\"currency\":\"USD\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C80609\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":2,\"productName\":\"USD日息体验\",\"progressPercent\":0.0000,\"redPacketPerUnit\":10,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":500000.00,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 14:45:02\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 16:30:58', 101);
INSERT INTO `sys_oper_log` VALUES (460, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"purple\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 14:44:40\",\"currency\":\"USD\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":200,\"params\":{},\"pointPerUnit\":1000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C80609\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":2,\"productName\":\"USD日息体验\",\"progressPercent\":0.0000,\"redPacketPerUnit\":10,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":500000.00,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":4000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 16:30:58\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 16:49:24', 30);
INSERT INTO `sys_oper_log` VALUES (461, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"purple\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 14:44:40\",\"currency\":\"USD\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":200,\"params\":{},\"pointPerUnit\":1000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C80609\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":2,\"productName\":\"USD日息体验\",\"progressPercent\":21.0050,\"redPacketPerUnit\":10,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":500000.00,\"soldShares\":4201,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":4000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 16:49:23\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 16:49:52', 35);
INSERT INTO `sys_oper_log` VALUES (462, '定时任务', 1, 'com.ruoyi.quartz.controller.SysJobController.add()', 'POST', 1, 'admin', NULL, '/monitor/job', '127.0.0.1', '内网IP', '{\"concurrent\":\"1\",\"createBy\":\"admin\",\"cronExpression\":\"0/10 0/5 * * * ?\",\"invokeTarget\":\"investOrderTask.settleIncome\",\"jobGroup\":\"DEFAULT\",\"jobId\":103,\"jobName\":\"投资结算\",\"misfirePolicy\":\"1\",\"nextValidTime\":\"2026-05-04 18:25:00\",\"params\":{},\"status\":\"1\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 18:21:26', 139);
INSERT INTO `sys_oper_log` VALUES (463, '定时任务', 2, 'com.ruoyi.quartz.controller.SysJobController.changeStatus()', 'PUT', 1, 'admin', NULL, '/monitor/job/changeStatus', '127.0.0.1', '内网IP', '{\"jobId\":103,\"misfirePolicy\":\"0\",\"params\":{},\"status\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 18:21:29', 31);
INSERT INTO `sys_oper_log` VALUES (464, '定时任务', 2, 'com.ruoyi.quartz.controller.SysJobController.edit()', 'PUT', 1, 'admin', NULL, '/monitor/job', '127.0.0.1', '内网IP', '{\"concurrent\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 18:21:25\",\"cronExpression\":\"0/10 0/10 * * * ?\",\"invokeTarget\":\"investOrderTask.settleIncome\",\"jobGroup\":\"DEFAULT\",\"jobId\":103,\"jobName\":\"投资结算\",\"misfirePolicy\":\"1\",\"nextValidTime\":\"2026-05-04 18:30:00\",\"params\":{},\"remark\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 18:21:29\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 18:24:25', 86);
INSERT INTO `sys_oper_log` VALUES (465, '定时任务', 2, 'com.ruoyi.quartz.controller.SysJobController.run()', 'PUT', 1, 'admin', NULL, '/monitor/job/run', '127.0.0.1', '内网IP', '{\"jobGroup\":\"DEFAULT\",\"jobId\":103,\"misfirePolicy\":\"0\",\"params\":{}} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 18:24:29', 28);
INSERT INTO `sys_oper_log` VALUES (466, '投资订单', 2, 'com.ruoyi.web.controller.system.SysInvestOrderController.redeem()', 'POST', 1, 'admin', NULL, '/system/invest/order/redeem', '127.0.0.1', '内网IP', '{\"orderId\":1,\"confirmText\":\"确认赎回\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 18:27:45', 29);
INSERT INTO `sys_oper_log` VALUES (467, '投资订单', 2, 'com.ruoyi.web.controller.system.SysInvestOrderController.redeem()', 'POST', 1, 'admin', NULL, '/system/invest/order/redeem', '127.0.0.1', '内网IP', '{\"orderId\":2,\"confirmText\":\"确认赎回\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 18:27:49', 44);
INSERT INTO `sys_oper_log` VALUES (468, '投资订单', 2, 'com.ruoyi.web.controller.system.SysInvestOrderController.redeem()', 'POST', 1, 'admin', NULL, '/system/invest/order/redeem', '127.0.0.1', '内网IP', '{\"orderId\":3,\"confirmText\":\"确认赎回\",\"googleCode\":\"846302\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 19:22:32', 50);
INSERT INTO `sys_oper_log` VALUES (469, '投资订单', 2, 'com.ruoyi.web.controller.system.SysInvestOrderController.redeem()', 'POST', 1, 'admin', NULL, '/system/invest/order/redeem', '127.0.0.1', '内网IP', '{\"orderId\":4,\"confirmText\":\"确认赎回\",\"googleCode\":\"147250\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 19:41:07', 73);
INSERT INTO `sys_oper_log` VALUES (470, 'User recharge submit', 1, 'com.ruoyi.web.controller.app.AppRechargeController.submit()', 'POST', 1, 'nnd1', NULL, '/app/recharge/submit', '192.168.140.1', '内网IP', '{\"data\":\"9ZAgTRaxDrSJsnbgvWUUO4nGmyKgl4rxq8T/Y6wUpYbZvNatpYRml/6zT5sEmb18TfOdI8y3PxoG0XAgFfKOOw==\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 19:52:48', 413);
INSERT INTO `sys_oper_log` VALUES (471, 'User recharge review', 2, 'com.ruoyi.web.controller.system.SysUserRechargeController.audit()', 'PUT', 1, 'admin', NULL, '/system/recharge', '127.0.0.1', '内网IP', '{\"amount\":2000.0,\"orderNo\":\"RC202605041952487B041872\",\"params\":{},\"rechargeId\":10,\"rejectReason\":\"\",\"reviewTime\":\"2026-05-04 19:53:47\",\"reviewUserId\":1,\"reviewUserName\":\"admin\",\"status\":1,\"userName\":\"nnd1\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 19:53:48', 355);
INSERT INTO `sys_oper_log` VALUES (472, '提现申请', 1, 'com.ruoyi.web.controller.app.AppWithdrawController.submit()', 'POST', 1, 'nnd1', NULL, '/app/withdraw/submit', '192.168.140.1', '内网IP', '{\"params\":{},\"userId\":1000107,\"userName\":\"nnd1\"} ', NULL, 1, '提现金额必须大于0。', '2026-05-04 20:06:01', 12);
INSERT INTO `sys_oper_log` VALUES (473, '提现申请', 1, 'com.ruoyi.web.controller.app.AppWithdrawController.submit()', 'POST', 1, 'nnd1', NULL, '/app/withdraw/submit', '192.168.140.1', '内网IP', '{\"data\":\"lEYmL4UgwFf2TktnopnO9o5KKRS6lSx2CoYol3dLSvslvvvWG3jAjs8ibHkYYe+ZKxjRno1UpbvKDl3/u8opt4MNJmmG/f6WJ/Rbtofv181CgnPGx2m0DnHO0MFrvjkXaHeH/9TmomLNdRq+qpf7saCdwDqz/CMed9YVliTKRv8=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 20:32:40', 1438);
INSERT INTO `sys_oper_log` VALUES (474, '提现审核', 2, 'com.ruoyi.web.controller.system.SysUserWithdrawController.audit()', 'PUT', 1, 'admin', NULL, '/system/withdraw', '127.0.0.1', '内网IP', '{\"withdrawId\":5,\"orderNo\":\"WD20260429210352EDC579DA\",\"userName\":\"lanz\",\"amount\":100,\"status\":1,\"rejectReason\":\"\",\"googleCode\":\"691006\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 20:36:01', 395);
INSERT INTO `sys_oper_log` VALUES (475, '提现审核', 2, 'com.ruoyi.web.controller.system.SysUserWithdrawController.audit()', 'PUT', 1, 'admin', NULL, '/system/withdraw', '127.0.0.1', '内网IP', '{\"withdrawId\":6,\"orderNo\":\"WD202605042032395831673C\",\"userName\":\"nnd1\",\"amount\":200,\"status\":1,\"rejectReason\":\"\",\"googleCode\":\"510327\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 20:36:34', 38);
INSERT INTO `sys_oper_log` VALUES (476, '投资订单', 2, 'com.ruoyi.web.controller.system.SysInvestOrderController.settle()', 'POST', 1, 'admin', NULL, '/system/invest/order/settle', '127.0.0.1', '内网IP', '{\"orderId\":5,\"confirmText\":\"确认结算\",\"googleCode\":\"978830\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 21:31:11', 783);
INSERT INTO `sys_oper_log` VALUES (477, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAYNYqxq4tABOKAUz7GnBo7R3LFJCiDXeGZUxlAxjviG+MmNoI3ZHHk3aBgIDs7asNo7dVBC2+VIjchtYGELbylw=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 21:48:39', 2042);
INSERT INTO `sys_oper_log` VALUES (478, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"params\":{}} ', '{\"msg\":\"Bank card ID cannot be empty.\",\"code\":500}', 0, NULL, '2026-05-04 21:54:01', 0);
INSERT INTO `sys_oper_log` VALUES (479, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"data\":\"9aAmPtRxvANDDABykDMwcSn4GRZ3dYeRLdGm5gIgjFc=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 21:58:35', 2506);
INSERT INTO `sys_oper_log` VALUES (480, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAYNYqxq4tABOKAUz7GnBo7TDd3uNi4qKR7I4w+lEgr6BIMJFolncS0xOa1morhxeRN+bsQLdxYqkNAPC4IrYyLE=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 21:59:20', 1323);
INSERT INTO `sys_oper_log` VALUES (481, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"data\":\"dXKb4xk3waxGAAPhOgCSaAmXlY8oaogYFjyk79kamXA=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:06:21', 1268);
INSERT INTO `sys_oper_log` VALUES (482, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAdgMJOUBZmNn3c7lxtsw7qjlnEHK/566HybODbtzIu6TuIl2stjfs1OtwFWhjoMj++giofghYVVKyO39eKSYvoMNGVIXW2VOnVNpqEQzhKu0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:08:13', 1186);
INSERT INTO `sys_oper_log` VALUES (483, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"data\":\"pfzLs9J2jFKNQEQN6Pg3P/VRcXYlTgRR/12CC04X9K0=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:09:46', 1768);
INSERT INTO `sys_oper_log` VALUES (484, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"data\":\"DrV43SPuEGM2YphCjbWWVrviAxQWSV25soWX/SYzGtc=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:09:50', 1188);
INSERT INTO `sys_oper_log` VALUES (485, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAYNYqxq4tABOKAUz7GnBo7TDd3uNi4qKR7I4w+lEgr6BIMJFolncS0xOa1morhxeRN+bsQLdxYqkNAPC4IrYyLE=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:10:31', 1188);
INSERT INTO `sys_oper_log` VALUES (486, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"data\":\"93A7YJRJEYVekDFRlHLFHWZnEAahj4umkPn/aXWTxYw=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:22:18', 1781);
INSERT INTO `sys_oper_log` VALUES (487, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAYNYqxq4tABOKAUz7GnBo7TDd3uNi4qKR7I4w+lEgr6BIMJFolncS0xOa1morhxeRN+bsQLdxYqkNAPC4IrYyLE=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:29:55', 1905);
INSERT INTO `sys_oper_log` VALUES (488, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAdgMJOUBZmNn3c7lxtsw7qjlnEHK/566HybODbtzIu6TjvlTxr8sl12ZMfPLQPDVEA9IBjdjktLHtb6ttKm2AFuTj0QIuganEdfXeOjIu7f+ZYBWPTZPf9tCJwM0ahOYng==\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 22:30:15', 1351);
INSERT INTO `sys_oper_log` VALUES (489, '实名认证审核', 2, 'com.ruoyi.web.controller.system.SysAppRealNameAuthController.edit()', 'PUT', 1, 'admin', NULL, '/system/realNameAuth', '127.0.0.1', '内网IP', '{\"authId\":7,\"status\":0,\"googleCode\":\"837355\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 23:12:59', 1375);
INSERT INTO `sys_oper_log` VALUES (490, 'Bank card delete', 3, 'com.ruoyi.web.controller.app.AppBankCardController.delete()', 'POST', 1, 'nnd1', NULL, '/app/bankCard/delete', '192.168.140.1', '内网IP', '{\"data\":\"f9fNaRDGsN1ar6sXHUOeUWx5yp4IfmvIBF/+uSTEM4I=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 23:13:10', 1312);
INSERT INTO `sys_oper_log` VALUES (491, '实名认证审核', 2, 'com.ruoyi.web.controller.system.SysAppRealNameAuthController.edit()', 'PUT', 1, 'admin', NULL, '/system/realNameAuth', '127.0.0.1', '内网IP', '{\"authId\":7,\"status\":1} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 23:19:54', 2602);
INSERT INTO `sys_oper_log` VALUES (492, '实名认证审核', 2, 'com.ruoyi.web.controller.system.SysAppRealNameAuthController.edit()', 'PUT', 1, 'admin', NULL, '/system/realNameAuth', '127.0.0.1', '内网IP', '{\"authId\":7,\"status\":0,\"googleCode\":\"256308\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 23:20:46', 1315);
INSERT INTO `sys_oper_log` VALUES (493, '实名认证审核', 2, 'com.ruoyi.web.controller.system.SysAppRealNameAuthController.edit()', 'PUT', 1, 'admin', NULL, '/system/realNameAuth', '127.0.0.1', '内网IP', '{\"authId\":7,\"status\":1} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-04 23:20:52', 1951);
INSERT INTO `sys_oper_log` VALUES (494, '投资产品', 1, 'com.ruoyi.web.controller.system.SysInvestProductController.copy()', 'POST', 1, 'admin', NULL, '/system/invest/product/copy/1', '127.0.0.1', '内网IP', '1 ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 10:58:27', 29);
INSERT INTO `sys_oper_log` VALUES (495, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:10:13\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 10:59:40', 56);
INSERT INTO `sys_oper_log` VALUES (496, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":1,\"endTime\":\"2026-05-05 11:05:00\",\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 10:59:40\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:00:43', 15);
INSERT INTO `sys_oper_log` VALUES (497, 'Bank card bind', 1, 'com.ruoyi.web.controller.app.AppBankCardController.add()', 'POST', 1, 'nnd1', NULL, '/app/bankCard', '192.168.140.1', '内网IP', '{\"data\":\"oAgJsURqlTlWh4E4HSqfAdgMJOUBZmNn3c7lxtsw7qjlnEHK/566HybODbtzIu6T0RikQQlMhOLCm7XbZ7xjoQ+K37kWEcz0DigdXHfLTq4wcbZUZFGigszj9SD+2giY\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:04:26', 2219);
INSERT INTO `sys_oper_log` VALUES (498, '提现申请', 1, 'com.ruoyi.web.controller.app.AppWithdrawController.submit()', 'POST', 1, 'nnd1', NULL, '/app/withdraw/submit', '192.168.140.1', '内网IP', '{\"data\":\"2M0wLdOAnZWxzhlkGGR/E4RF1OrsnarCSm6nbv7eqPcWNHYdiaA8cul31DEsYWmSmSnZh/T50kbwrdh2t/bnztpZLZlVyjwHP2LLET92Eww6P4ZzQYPMAPcbSIrQJ+h1GH3JohwEh9yh5pqwQfG9eounjVBB4zi3srTBo4oFDtQ=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:04:40', 1448);
INSERT INTO `sys_oper_log` VALUES (499, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:00:43\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:08:14', 86);
INSERT INTO `sys_oper_log` VALUES (500, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":1,\"endTime\":\"2028-05-05 11:05:00\",\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:08:14\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:08:52', 50);
INSERT INTO `sys_oper_log` VALUES (501, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"1\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":5,\"endTime\":\"2028-05-05 11:05:00\",\"groupEnabled\":\"1\",\"groupRate\":1.5,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"DAILY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":2,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单，必须拼团成团。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1.2,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[2,3],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:08:52\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:10:22', 19);
INSERT INTO `sys_oper_log` VALUES (502, '参数管理', 1, 'com.ruoyi.web.controller.system.SysConfigController.add()', 'POST', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configKey\":\"sys.realpdd\",\"configName\":\"是否启用真实拼团\",\"configType\":\"N\",\"configValue\":\"false\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"isAppConfig\":\"0\",\"params\":{}} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:17:24', 40);
INSERT INTO `sys_oper_log` VALUES (503, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":128,\"configKey\":\"sys.realpdd\",\"configName\":\"是否启用真实拼团\",\"configType\":\"N\",\"configValue\":\"false\",\"configValueType\":\"SWITCH\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 11:17:24\",\"isAppConfig\":\"1\",\"params\":{},\"updateBy\":\"admin\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:17:35', 32);
INSERT INTO `sys_oper_log` VALUES (504, '参数管理', 3, 'com.ruoyi.web.controller.system.SysConfigController.remove()', 'DELETE', 1, 'admin', NULL, '/system/config/128', '127.0.0.1', '内网IP', '[128] ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:17:47', 25);
INSERT INTO `sys_oper_log` VALUES (505, '参数管理', 9, 'com.ruoyi.web.controller.system.SysConfigController.refreshCache()', 'DELETE', 1, 'admin', NULL, '/system/config/refreshCache', '127.0.0.1', '内网IP', '', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:24:03', 12165);
INSERT INTO `sys_oper_log` VALUES (506, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"1\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":5,\"endTime\":\"2028-05-05 11:05:00\",\"groupEnabled\":\"1\",\"groupRate\":1.5,\"groupSize\":3,\"growthPerUnit\":500,\"interestMode\":\"DAILY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":2,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单，必须拼团成团。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1.2,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[2,3],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:10:22\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:29:59', 21);
INSERT INTO `sys_oper_log` VALUES (507, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"1\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":5,\"endTime\":\"2028-05-05 11:05:00\",\"groupEnabled\":\"1\",\"groupRate\":1.5,\"groupSize\":3,\"growthPerUnit\":500,\"interestMode\":\"DAILY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":2,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单，必须拼团成团。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1.2,\"soldAmount\":0.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[2,3],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:29:59\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:30:25', 30);
INSERT INTO `sys_oper_log` VALUES (508, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"1\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 10:58:27\",\"currency\":\"CNY\",\"cycleDays\":5,\"endTime\":\"2028-05-05 11:05:00\",\"groupEnabled\":\"1\",\"groupRate\":1.5,\"groupSize\":3,\"growthPerUnit\":500,\"interestMode\":\"DAILY\",\"interestStageCount\":0,\"investMode\":\"AMOUNT\",\"limitLevel\":0,\"limitTimes\":2,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C907436\",\"productContent\":\"新手高回报体验产品，每人限购一单，必须拼团成团。\",\"productId\":3,\"productName\":\"人民币定时测试\",\"progressPercent\":2.5000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1.2,\"soldAmount\":500000.00,\"soldShares\":0,\"startTime\":\"2026-05-05 11:00:00\",\"status\":\"0\",\"tagIds\":[2,3],\"totalAmount\":20000000.00,\"totalShares\":0,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:30:25\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:36:22', 68);
INSERT INTO `sys_oper_log` VALUES (509, '定时任务', 2, 'com.ruoyi.quartz.controller.SysJobController.edit()', 'PUT', 1, 'admin', NULL, '/monitor/job', '127.0.0.1', '内网IP', '{\"concurrent\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 18:21:25\",\"cronExpression\":\"* 0/8 * * * ?\",\"invokeTarget\":\"investOrderTask.settleIncome\",\"jobGroup\":\"DEFAULT\",\"jobId\":103,\"jobName\":\"投资结算与拼团退款\",\"misfirePolicy\":\"1\",\"nextValidTime\":\"2026-05-05 11:48:18\",\"params\":{},\"remark\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-04 18:24:24\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:48:17', 188);
INSERT INTO `sys_oper_log` VALUES (510, '定时任务', 2, 'com.ruoyi.quartz.controller.SysJobController.edit()', 'PUT', 1, 'admin', NULL, '/monitor/job', '127.0.0.1', '内网IP', '{\"concurrent\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-04 18:21:25\",\"cronExpression\":\"* 0/10 * * * ?\",\"invokeTarget\":\"investOrderTask.settleIncome\",\"jobGroup\":\"DEFAULT\",\"jobId\":103,\"jobName\":\"投资结算与拼团退款\",\"misfirePolicy\":\"1\",\"nextValidTime\":\"2026-05-05 11:50:00\",\"params\":{},\"remark\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:48:17\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:49:01', 77);
INSERT INTO `sys_oper_log` VALUES (511, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":106,\"configKey\":\"app.currency.investMode\",\"configName\":\"APP配置-投资货币方式\",\"configType\":\"N\",\"configValue\":\"1=单币种\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-28 22:01:48\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"1=单币种,2=双币种\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:58:01\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:58:54', 56);
INSERT INTO `sys_oper_log` VALUES (512, '参数管理', 2, 'com.ruoyi.web.controller.system.SysConfigController.edit()', 'PUT', 1, 'admin', NULL, '/system/config', '127.0.0.1', '内网IP', '{\"configId\":106,\"configKey\":\"app.currency.investMode\",\"configName\":\"APP配置-投资货币方式\",\"configType\":\"N\",\"configValue\":\"2\",\"configValueType\":\"SELECT\",\"createBy\":\"admin\",\"createTime\":\"2026-04-28 22:01:48\",\"isAppConfig\":\"1\",\"params\":{},\"remark\":\"1=单币种,2=双币种\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 11:58:54\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 11:59:01', 83);
INSERT INTO `sys_oper_log` VALUES (513, '安全问题设置', 1, 'com.ruoyi.web.controller.system.SysUserSecurityAnswerController.setAnswers()', 'POST', 1, 'lanz', NULL, '/app/user/security/answers', '192.168.140.1', '内网IP', '{\"data\":\"vVyo323vV52yjHngr4Hm0ZAlJcfU/Ve1CYMdIva7oequRujBWllfqHUpc9o7Ig+uRf3FbGiv9viWRB231/5jwEdiifr0OE/HJMeSXVFmCA0=\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 13:27:14', 1506);
INSERT INTO `sys_oper_log` VALUES (514, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"system/news/article/index\",\"createTime\":\"2026-04-30 16:39:37\",\"icon\":\"dict\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2018,\"menuName\":\"新闻文章\",\"menuType\":\"C\",\"orderNum\":2,\"params\":{},\"parentId\":2016,\"path\":\"newsArticle\",\"perms\":\"system:news:article:list\",\"query\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 14:16:20', 52);
INSERT INTO `sys_oper_log` VALUES (515, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{\"children\":[],\"component\":\"system/appAd/index\",\"createTime\":\"2026-05-05 14:12:27\",\"icon\":\"international\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2055,\"menuName\":\"APP广告管理\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":2016,\"path\":\"appAd\",\"perms\":\"system:news:article:list\",\"query\":\"\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 14:16:35', 26);
INSERT INTO `sys_oper_log` VALUES (516, '新闻文章', 1, 'com.ruoyi.web.controller.system.SysNewsArticleController.add()', 'POST', 1, 'admin', NULL, '/system/news/article', '127.0.0.1', '内网IP', '{\"articleContent\":\"\",\"articleTitle\":\"首页1\",\"categoryCode\":\"APP_HOME_BANNER\",\"coverImage\":\"https://img.1trx.in/avatar/b861d26a0a054056be402cb8b6fcf56a.png\",\"createBy\":\"admin\",\"params\":{},\"remark\":\"\",\"sortOrder\":0,\"status\":\"0\",\"summary\":\"\",\"topFlag\":\"0\"} ', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'category_id\' doesn\'t have a default value\r\n### The error may exist in file [E:\\Go\\go-api\\ruoyi-system\\target\\classes\\mapper\\system\\SysNewsArticleMapper.xml]\r\n### The error may involve com.ruoyi.system.mapper.SysNewsArticleMapper.insertNewsArticle-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into sys_news_article (                            category_code,               article_title,                             cover_image,                             sort_order,               top_flag,               status,                            create_by, create_time         ) values (                            ?,               ?,                             ?,                             ?,               ?,               ?,                            ?, now()         )\r\n### Cause: java.sql.SQLException: Field \'category_id\' doesn\'t have a default value\n; Field \'category_id\' doesn\'t have a default value', '2026-05-05 14:37:53', 91);
INSERT INTO `sys_oper_log` VALUES (517, '新闻文章', 1, 'com.ruoyi.web.controller.system.SysNewsArticleController.add()', 'POST', 1, 'admin', NULL, '/system/news/article', '127.0.0.1', '内网IP', '{\"articleContent\":\"\",\"articleTitle\":\"首页1\",\"categoryCode\":\"APP_HOME_BANNER\",\"coverImage\":\"https://img.1trx.in/avatar/b861d26a0a054056be402cb8b6fcf56a.png\",\"createBy\":\"admin\",\"params\":{},\"remark\":\"\",\"sortOrder\":0,\"status\":\"0\",\"summary\":\"\",\"topFlag\":\"0\"} ', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'category_id\' doesn\'t have a default value\r\n### The error may exist in file [E:\\Go\\go-api\\ruoyi-system\\target\\classes\\mapper\\system\\SysNewsArticleMapper.xml]\r\n### The error may involve com.ruoyi.system.mapper.SysNewsArticleMapper.insertNewsArticle-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into sys_news_article (                            category_code,               article_title,                             cover_image,                             sort_order,               top_flag,               status,                            create_by, create_time         ) values (                            ?,               ?,                             ?,                             ?,               ?,               ?,                            ?, now()         )\r\n### Cause: java.sql.SQLException: Field \'category_id\' doesn\'t have a default value\n; Field \'category_id\' doesn\'t have a default value', '2026-05-05 15:01:35', 204);
INSERT INTO `sys_oper_log` VALUES (518, '新闻文章', 1, 'com.ruoyi.web.controller.system.SysNewsArticleController.add()', 'POST', 1, 'admin', NULL, '/system/news/article', '127.0.0.1', '内网IP', '{\"articleContent\":\"\",\"articleId\":5,\"articleTitle\":\"首页1\",\"categoryCode\":\"APP_HOME_BANNER\",\"categoryId\":3,\"coverImage\":\"https://img.1trx.in/avatar/b861d26a0a054056be402cb8b6fcf56a.png\",\"createBy\":\"admin\",\"params\":{},\"remark\":\"\",\"sortOrder\":0,\"status\":\"0\",\"summary\":\"\",\"topFlag\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 15:05:09', 703);
INSERT INTO `sys_oper_log` VALUES (519, '新闻文章', 1, 'com.ruoyi.web.controller.system.SysNewsArticleController.add()', 'POST', 1, 'admin', NULL, '/system/news/article', '127.0.0.1', '内网IP', '{\"articleContent\":\"\",\"articleId\":6,\"articleTitle\":\"首页广告1\",\"categoryCode\":\"APP_HOME_AD\",\"categoryId\":4,\"coverImage\":\"https://img.1trx.in/avatar/88b8c0e6aaa14c1883495d96bebd46d9.png\",\"createBy\":\"admin\",\"params\":{},\"remark\":\"\",\"sortOrder\":0,\"status\":\"0\",\"summary\":\"\",\"topFlag\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 15:06:50', 396);
INSERT INTO `sys_oper_log` VALUES (520, '新闻文章', 1, 'com.ruoyi.web.controller.system.SysNewsArticleController.add()', 'POST', 1, 'admin', NULL, '/system/news/article', '127.0.0.1', '内网IP', '{\"articleContent\":\"\",\"articleId\":7,\"articleTitle\":\"首页广告2\",\"categoryCode\":\"APP_HOME_AD\",\"categoryId\":4,\"coverImage\":\"https://img.1trx.in/avatar/f12386d9558b4277ac5497ac90a14dab.png\",\"createBy\":\"admin\",\"params\":{},\"remark\":\"\",\"sortOrder\":0,\"status\":\"0\",\"summary\":\"\",\"topFlag\":\"0\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 15:09:48', 658);
...
INSERT INTO `sys_oper_log` VALUES (528, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 18:06:16\",\"currency\":\"CNY\",\"cycleDays\":1,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"MATURITY\",\"interestStageCount\":0,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C576251\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":4,\"productName\":\"人民币等级优惠测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 18:06:49\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:13:59', 52);
INSERT INTO `sys_oper_log` VALUES (529, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 18:06:16\",\"currency\":\"CNY\",\"cycleDays\":10,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"STAGED\",\"interestStageCount\":2,\"investMode\":\"SHARE\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":1000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C576251\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":4,\"productName\":\"人民币等级优惠测试\",\"progressPercent\":0.0000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":0.00,\"soldShares\":0,\"stageConfigJson\":\"{\\\"interestStages\\\":[{\\\"stageNo\\\":1,\\\"days\\\":1,\\\"ratio\\\":50,\\\"remark\\\":\\\"\\\"},{\\\"stageNo\\\":2,\\\"days\\\":1,\\\"ratio\\\":50,\\\"remark\\\":\\\"\\\"}],\\\"principalStages\\\":[]}\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":20000,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 22:13:59\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:16:32', 13);
INSERT INTO `sys_oper_log` VALUES (530, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 18:06:16\",\"currency\":\"CNY\",\"cycleDays\":10,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"STAGED\",\"interestStageCount\":2,\"investMode\":\"AMOUNT\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":50000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C576251\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":4,\"productName\":\"人民币等级优惠测试\",\"progressPercent\":4.5000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":900000.00,\"soldShares\":0,\"stageConfigJson\":\"{\\\"interestStages\\\":[{\\\"stageNo\\\":1,\\\"days\\\":1,\\\"ratio\\\":50,\\\"remark\\\":\\\"\\\"},{\\\"stageNo\\\":2,\\\"days\\\":1,\\\"ratio\\\":50,\\\"remark\\\":\\\"\\\"}],\\\"principalStages\\\":[]}\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":0,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 22:16:32\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:19:04', 12);
INSERT INTO `sys_oper_log` VALUES (531, 'User recharge submit', 1, 'com.ruoyi.web.controller.app.AppRechargeController.submit()', 'POST', 1, 'nnd1', NULL, '/app/recharge/submit', '192.168.140.1', '内网IP', '{\"data\":\"f59+xV/wSOZN0gYjPS17A01Aju0ccNt/QQLmtSVrW+D7LBuX6ILV5m1nXGZ/vgFIr+pS7TyvQn1zp/rMTPdWJA==\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:21:14', 40);
INSERT INTO `sys_oper_log` VALUES (532, 'User recharge review', 2, 'com.ruoyi.web.controller.system.SysUserRechargeController.audit()', 'PUT', 1, 'admin', NULL, '/system/recharge', '127.0.0.1', '内网IP', '{\"amount\":150000.0,\"orderNo\":\"RC20260505222114156E5A28\",\"params\":{},\"rechargeId\":11,\"rejectReason\":\"\",\"reviewTime\":\"2026-05-05 22:21:26\",\"reviewUserId\":1,\"reviewUserName\":\"admin\",\"status\":1,\"userName\":\"nnd1\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:21:26', 30);
INSERT INTO `sys_oper_log` VALUES (533, '优惠券模板管理', 2, 'com.ruoyi.web.controller.system.SysCouponTemplateController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/coupon', '127.0.0.1', '内网IP', '{\"bonusPrincipal\":0,\"bonusRate\":0,\"couponId\":1,\"couponName\":\"减满体验券\",\"couponType\":\"FULL_REDUCTION\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 20:05:21\",\"discountAmount\":50,\"experiencePrincipal\":0,\"maxExperienceUnits\":0,\"minAmount\":1000,\"minExperienceUnits\":0,\"params\":{},\"receivedCount\":0,\"scopeType\":\"GLOBAL\",\"status\":\"0\",\"totalCount\":0,\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 20:07:06\",\"validDays\":90} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:25:52', 19);
INSERT INTO `sys_oper_log` VALUES (534, '优惠券发放', 2, 'com.ruoyi.web.controller.system.SysCouponTemplateController.grant()', 'POST', 1, 'admin', NULL, '/system/invest/coupon/grant', '127.0.0.1', '内网IP', '{\"couponId\":1,\"grantTargetType\":\"FILTER\",\"grantType\":\"MANUAL\",\"status\":\"0\",\"userIds\":[1000107]} ', '{\"msg\":\"已发放 1 张\",\"code\":200}', 0, NULL, '2026-05-05 22:26:16', 30);
INSERT INTO `sys_oper_log` VALUES (535, '投资产品', 2, 'com.ruoyi.web.controller.system.SysInvestProductController.edit()', 'PUT', 1, 'admin', NULL, '/system/invest/product', '127.0.0.1', '内网IP', '{\"autoGroup\":\"0\",\"cardTheme\":\"blue\",\"couponEnabled\":\"1\",\"createBy\":\"admin\",\"createTime\":\"2026-05-05 18:06:16\",\"currency\":\"CNY\",\"cycleDays\":10,\"groupEnabled\":\"0\",\"groupRate\":1.2,\"groupSize\":2,\"growthPerUnit\":500,\"interestMode\":\"STAGED\",\"interestStageCount\":3,\"investMode\":\"AMOUNT\",\"limitLevel\":0,\"limitTimes\":1,\"maxInvestAmount\":50000,\"minInvestAmount\":1000,\"params\":{},\"pointPerUnit\":2000,\"principalMode\":\"MATURITY\",\"principalStageCount\":0,\"productCode\":\"CN0504A_C576251\",\"productContent\":\"新手高回报体验产品，每人限购一单。\",\"productId\":4,\"productName\":\"人民币等级优惠测试\",\"progressPercent\":4.5000,\"redPacketPerUnit\":0,\"riskTag\":\"中低风险\",\"singleRate\":1,\"soldAmount\":900000.00,\"soldShares\":0,\"stageConfigJson\":\"{\\\"interestStages\\\":[{\\\"stageNo\\\":1,\\\"days\\\":1,\\\"ratio\\\":30,\\\"remark\\\":\\\"\\\"},{\\\"stageNo\\\":2,\\\"days\\\":1,\\\"ratio\\\":30,\\\"remark\\\":\\\"\\\"},{\\\"stageNo\\\":3,\\\"days\\\":1,\\\"ratio\\\":40,\\\"remark\\\":\\\"\\\"}],\\\"principalStages\\\":[]}\",\"status\":\"0\",\"tagIds\":[1,2],\"totalAmount\":20000000.00,\"totalShares\":0,\"tradeRuleContent\":\"本产品为到期返息产品\\n产品到期后会将产生的收益和本金全部返回至用户账号\\n如需提现可自行提交，系统客服会在24小时内处理提现事宜\",\"updateBy\":\"admin\",\"updateTime\":\"2026-05-05 22:19:04\"} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:33:38', 29);
INSERT INTO `sys_oper_log` VALUES (536, '等级体验券模板', 1, 'com.ruoyi.web.controller.system.SysLevelTrialTemplateController.add()', 'POST', 1, 'admin', NULL, '/system/invest/trial', '127.0.0.1', '内网IP', '{\"bonusRate\":0.8,\"createBy\":\"admin\",\"params\":{},\"receivedCount\":0,\"status\":\"0\",\"totalCount\":0,\"trialId\":1,\"trialLevel\":5,\"trialName\":\"5级体验卡\",\"validDays\":10} ', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2026-05-05 22:35:38', 8);
INSERT INTO `sys_oper_log` VALUES (537, '等级体验券发放', 2, 'com.ruoyi.web.controller.system.SysLevelTrialTemplateController.grant()', 'POST', 1, 'admin', NULL, '/system/invest/trial/grant', '127.0.0.1', '内网IP', '{\"grantType\":\"MANUAL\",\"trialId\":1,\"userIds\":[1000107]} ', '{\"msg\":\"已发放1张\",\"code\":200}', 0, NULL, '2026-05-05 22:47:52', 45);
...
CREATE TABLE `sys_security_question`  (
  ...
  `question_order` int NULL DEFAULT 0 COMMENT '排序',
...
CREATE TABLE `sys_team_level`  (
  `team_level_id` bigint NOT NULL AUTO_INCREMENT COMMENT '团队等级ID',
  `team_level` int NOT NULL COMMENT '团队长等级',
  `team_level_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '等级名称',
  `required_user_level` int NOT NULL DEFAULT 0 COMMENT '自身等级要求',
  `required_direct_users` int NOT NULL DEFAULT 0 COMMENT '直推有效用户数',
  `required_team_users` int NOT NULL DEFAULT 0 COMMENT '团队有效用户数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '团队等级配置' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_team_relation`  (
  `ancestor_user_id` bigint NOT NULL COMMENT '祖先用户ID（上级）',
  `descendant_user_id` bigint NOT NULL COMMENT '后代用户ID（下级）',
  `depth` int NOT NULL COMMENT '层级深度：1=直推，2=间推...',
...
CREATE TABLE `sys_team_stat_daily`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `team_level` int NOT NULL DEFAULT 0 COMMENT '团队长等级',
  `calc_depth` int NOT NULL DEFAULT 3 COMMENT '统计层级',
  `direct_user_count` int NOT NULL DEFAULT 0 COMMENT '直推人数',
  `direct_valid_user_count` int NOT NULL DEFAULT 0 COMMENT '直推有效人数',
  `team_user_count` int NOT NULL DEFAULT 0 COMMENT '团队总人数',
  `team_valid_user_count` int NOT NULL DEFAULT 0 COMMENT '团队有效人数',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '团队统计每日快照表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_team_stat_event`  (
  ...
  `stat_date` date NOT NULL COMMENT '统计日期',
  `owner_user_id` bigint NOT NULL COMMENT '团队拥有者（上级）',
  `member_user_id` bigint NOT NULL COMMENT '事件成员（下级）',
  `relation_depth` int NOT NULL DEFAULT 0 COMMENT '关系深度',
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '团队统计事件流水表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_team_stat_event` VALUES (10, '2026-05-04', 1000100, 1000107, 1, 'INVEST', 1000.00, 1, 'IPO:6', '2026-05-04 22:04:26', '2026-05-04 22:04:26');
INSERT INTO `sys_team_stat_event` VALUES (11, '2026-05-05', 1000100, 1000107, 1, 'INVEST', 1000.00, 1, 'IPO:7', '2026-05-05 12:22:41', '2026-05-05 12:22:41');
INSERT INTO `sys_team_stat_event` VALUES (12, '2026-05-05', 1000100, 1000107, 1, 'INVEST', 1000.00, 1, 'IPO:8', '2026-05-05 12:25:19', '2026-05-05 12:25:19');
...
CREATE TABLE `sys_user`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `invite_code` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户邀请码',
  `level_detail` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '0' COMMENT '层级详情，例如0,100,200',
  `user_level` int NOT NULL DEFAULT 0 COMMENT '用户层级，根用户为0',
  ...
  `real_name_status` tinyint NOT NULL DEFAULT -1 COMMENT '实名认证状态：-1未提交，0待审核，1通过，2拒绝',
  `default_currency` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'CNY' COMMENT '默认币种：CNY(人民币), USD(美元)',
  ...
  `team_leader_level` int NOT NULL DEFAULT 0 COMMENT '团队长级别',
  PRIMARY KEY (`user_id`) USING BTREE,
  UNIQUE INDEX `uk_sys_user_invite_code`(`invite_code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000108 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user` VALUES (1000103, NULL, 'liyats', 'liyats', NULL, '00', '', '', '0', NULL, '', '$2a$10$39lvbALbw5Y26HvHAJjkZ.40H9QZSHpTtCRr/WuGhKLIxttn3wvNu', '0', '0', '', NULL, '2026-05-01 17:12:18', '', '2026-05-01 17:12:18', '', NULL, NULL, 'KLQQU2', '0,1', 1, 0, NULL, -1, 'CNY', 0, 0.00, 0.00, 0, 0);
...
CREATE TABLE `sys_user_bank_card`  (
  `bank_card_id` bigint NOT NULL AUTO_INCREMENT COMMENT '银行卡ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户银行卡表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_bank_card` VALUES (9, 1000107, 'nnd1', 'USD', NULL, NULL, NULL, 'TBBpKV1oWg9hx4yt7mp8u5oSq5LPvPhUZ5', NULL, 'nnd1', '2026-05-04 22:29:55', 'nnd1', '2026-05-04 22:29:55');
INSERT INTO `sys_user_bank_card` VALUES (11, 1000107, 'nnd1', 'CNY', '工行', '2342423423423432', 'xtsd', NULL, NULL, 'nnd1', '2026-05-05 11:04:26', 'nnd1', '2026-05-05 11:04:26');

-- ----------------------------
-- Table structure for sys_user_google_auth
-- ----------------------------
DROP TABLE IF EXISTS `sys_user_google_auth`;
CREATE TABLE `sys_user_google_auth`  (
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `secret` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Google TOTP密钥(Base32)',
  `enabled` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否启用(1启用 0停用)',
  `bind_time` datetime NULL DEFAULT NULL COMMENT '绑定时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '后台用户Google验证绑定表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_user_google_auth
-- ----------------------------
INSERT INTO `sys_user_google_auth` VALUES (1, 'AMEMV6V4ZN3ZEIQLPWKAEWBLVY7GC6BX', 1, '2026-05-04 19:21:27', '2026-05-04 19:21:27');
...
CREATE TABLE `sys_user_growth_log`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '用户名',
  `change_value` bigint NOT NULL COMMENT '变动成长值（可正可负）',
  `growth_value_before` bigint NOT NULL DEFAULT 0 COMMENT '变动前成长值',
  `growth_value_after` bigint NOT NULL DEFAULT 0 COMMENT '变动后成长值',
  `change_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'increase' COMMENT '变动类型：increase/decrease',
  `source_type` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'manual' COMMENT '来源类型',
  `source_id` bigint NULL DEFAULT NULL COMMENT '来源ID',
  `source_no` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '来源单号',
  `status` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'success' COMMENT '状态',
  `operator_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '操作人',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`log_id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户成长值变动日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_growth_log` VALUES (7, 1000107, 'nnd1', 500, 8000, 8500, 'increase', 'invest_settlement', 5, 'IO202605041957471000107', 'success', 'admin', '投资订单到期结算发放成长值', '2026-05-04 21:31:12', '2026-05-04 21:31:12');
INSERT INTO `sys_user_growth_log` VALUES (8, 1000107, 'nnd1', 1, 8500, 8501, 'increase', 'yebao_settlement', 5, 'YB1777807481691b561adf8', 'success', 'system', '余额宝结算增加成长值', '2026-05-06 00:00:00', '2026-05-06 00:00:00');
...
CREATE TABLE `sys_user_level`  (
  ...
  `level_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '等级名称',
  `required_growth_value` bigint NOT NULL DEFAULT 0 COMMENT '所需成长值',
  `invest_bonus` decimal(18, 2) NOT NULL DEFAULT 0.00 COMMENT '投资分红比例',
  `icon` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '等级图标',
  `status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户等级表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_user_miner`  (
  `user_miner_id` bigint NOT NULL AUTO_INCREMENT COMMENT '用户矿机ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `miner_id` bigint NOT NULL COMMENT '矿机ID',
...
CREATE TABLE `sys_user_point_account`  (
  `point_account_id` bigint NOT NULL AUTO_INCREMENT COMMENT '积分账户ID',
  `user_id` bigint NOT NULL COMMENT '用户ID',
...
CREATE TABLE `sys_user_point_log`  (
  `log_id` bigint NOT NULL AUTO_INCREMENT COMMENT '账变ID',
  ...
  `source_id` bigint NULL DEFAULT NULL COMMENT '业务来源ID',
...
CREATE TABLE `sys_user_recharge`  (
  ...
  `currency_type` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'CNY' COMMENT '币种（CNY/USD）',
  `recharge_method` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'RMB' COMMENT '充值方式（RMB/USDT）',
  `amount` decimal(18, 2) NOT NULL DEFAULT 0.00 COMMENT '充值金额',
  `wallet_id` bigint NULL DEFAULT NULL COMMENT '入账钱包ID',
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '状态（0待审核 1已通过 2已拒绝）',
  `reject_reason` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '拒绝原因',
  `submit_time` datetime NULL DEFAULT NULL COMMENT '提交时间',
  `review_time` datetime NULL DEFAULT NULL COMMENT '审核时间',
  `review_user_id` bigint NULL DEFAULT NULL COMMENT '审核人ID',
  `review_user_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '审核人姓名',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户充值表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_recharge` VALUES (10, 'RC202605041952487B041872', 1000107, 'nnd1', 'CNY', 'RMB', 2000.00, 20, 1, NULL, '2026-05-04 19:52:48', '2026-05-04 19:53:48', 1, 'admin', NULL, '2026-05-04 19:52:48', '2026-05-04 19:53:48');
INSERT INTO `sys_user_recharge` VALUES (11, 'RC20260505222114156E5A28', 1000107, 'nnd1', 'CNY', 'RMB', 150000.00, 20, 1, NULL, '2026-05-05 22:21:15', '2026-05-05 22:21:27', 1, 'admin', NULL, '2026-05-05 22:21:15', '2026-05-05 22:21:27');
...
INSERT INTO `sys_user_wallet` VALUES (3, 1000100, 'CNY', 1300.00, 2500.00, 0.00, 0.00, 0.00, 0.00, 6000.00, 1500.00, '2026-04-25 15:17:46', '2026-05-05 13:27:01');
...
INSERT INTO `sys_user_wallet` VALUES (7, 1000100, 'USD', 0.00, 2000.00, 0.00, 0.00, 0.00, 0.00, 2000.00, 100.00, '2026-04-27 20:59:04', '2026-05-04 20:36:02');
...
INSERT INTO `sys_user_wallet` VALUES (20, 1000107, 'CNY', 2000.00, 150711.20, 0.00, 100.00, 11.20, 0.00, 155000.00, 200.00, '2026-05-02 13:12:17', '2026-05-05 22:21:27');
INSERT INTO `sys_user_wallet` VALUES (21, 1000107, 'USD', 1000.00, 2000.20, 0.00, 0.00, 0.00, 0.00, 3000.00, 0.00, '2026-05-02 13:12:17', '2026-05-04 22:04:26');
...
CREATE TABLE `sys_user_wallet_log`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户账变表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_wallet_log` VALUES (32, 1000107, 20, 'CNY', 100.00, 'invest', 'success', 1500.00, 1400.00, 'YB1777880155561fb815f26', 'nnd1', 'Yebao purchase', '2026-05-04 15:35:56', '2026-05-04 15:35:55');
INSERT INTO `sys_user_wallet_log` VALUES (33, 1000107, 20, 'CNY', 400.00, 'invest', 'success', 1400.00, 1000.00, 'YB1777881071457311592a0', 'nnd1', 'Yebao purchase', '2026-05-04 15:51:11', '2026-05-04 15:51:11');
INSERT INTO `sys_user_wallet_log` VALUES (34, 1000107, 20, 'CNY', 1000.00, 'invest', 'success', 1000.00, 0.00, 'IO202605041555361000107', 'nnd1', 'APP在线签约认购', '2026-05-04 15:55:36', '2026-05-04 15:55:36');
INSERT INTO `sys_user_wallet_log` VALUES (35, 1000107, 21, 'USD', 200.00, 'invest', 'success', 3000.00, 2800.00, 'IO202605041650241000107', 'nnd1', 'APP在线签约认购', '2026-05-04 16:50:25', '2026-05-04 16:50:24');
INSERT INTO `sys_user_wallet_log` VALUES (36, 1000107, 20, 'CNY', 1000.00, 'redeem', 'success', 0.00, 1000.00, 'IO202605041555361000107', 'admin', '后台赎回，仅退还本金', '2026-05-04 18:27:45', '2026-05-04 18:27:45');
INSERT INTO `sys_user_wallet_log` VALUES (37, 1000107, 21, 'USD', 200.00, 'redeem', 'success', 2800.00, 3000.00, 'IO202605041650241000107', 'admin', '后台赎回，仅退还本金', '2026-05-04 18:27:50', '2026-05-04 18:27:49');
INSERT INTO `sys_user_wallet_log` VALUES (38, 1000107, 20, 'CNY', 1000.00, 'invest', 'success', 1000.00, 0.00, 'IO202605041834391000107', 'nnd1', 'APP在线签约认购', '2026-05-04 18:34:40', '2026-05-04 18:34:39');
INSERT INTO `sys_user_wallet_log` VALUES (39, 1000107, 20, 'CNY', 1000.00, 'redeem', 'success', 0.00, 1000.00, 'IO202605041834391000107', 'admin', '后台赎回，仅退还本金', '2026-05-04 19:22:32', '2026-05-04 19:22:32');
INSERT INTO `sys_user_wallet_log` VALUES (40, 1000107, 20, 'CNY', 1000.00, 'invest', 'success', 1000.00, 0.00, 'IO202605041936261000107', 'nnd1', 'APP在线签约认购', '2026-05-04 19:36:26', '2026-05-04 19:36:26');
INSERT INTO `sys_user_wallet_log` VALUES (41, 1000107, 20, 'CNY', 1000.00, 'redeem', 'success', 0.00, 1000.00, 'IO202605041936261000107', 'admin', '后台赎回，仅退还本金', '2026-05-04 19:41:08', '2026-05-04 19:41:07');
INSERT INTO `sys_user_wallet_log` VALUES (42, 1000107, 20, 'CNY', 2000.00, 'recharge', 'success', 1000.00, 3000.00, 'RC202605041952487B041872', 'admin', 'Recharge approved', '2026-05-04 19:53:48', '2026-05-04 19:53:48');
INSERT INTO `sys_user_wallet_log` VALUES (43, 1000107, 20, 'CNY', 1000.00, 'invest', 'success', 3000.00, 2000.00, 'IO202605041957471000107', 'nnd1', 'APP在线签约认购', '2026-05-04 19:57:47', '2026-05-04 19:57:47');
INSERT INTO `sys_user_wallet_log` VALUES (44, 1000107, 20, 'CNY', -200.00, 'frozen', 'pending', 2000.00, 1800.00, 'WD202605042032395831673C', 'nnd1', '提现提交并冻结金额', '2026-05-04 20:32:40', '2026-05-04 20:32:40');
INSERT INTO `sys_user_wallet_log` VALUES (45, 1000100, 7, 'USD', 0.00, 'withdraw', 'success', 2000.00, 2000.00, 'WD20260429210352EDC579DA', 'admin', '提现审核通过，冻结金额已扣除', '2026-05-04 20:36:02', '2026-05-04 20:36:02');
INSERT INTO `sys_user_wallet_log` VALUES (46, 1000107, 20, 'CNY', 0.00, 'withdraw', 'success', 1800.00, 1800.00, 'WD202605042032395831673C', 'admin', '提现审核通过，冻结金额已扣除', '2026-05-04 20:36:34', '2026-05-04 20:36:34');
INSERT INTO `sys_user_wallet_log` VALUES (47, 1000107, 20, 'CNY', 1000.00, 'redeem', 'success', 1800.00, 2800.00, 'IO202605041957471000107', 'admin', '后台强制结算返还未结算本金', '2026-05-04 21:31:12', '2026-05-04 21:31:11');
INSERT INTO `sys_user_wallet_log` VALUES (48, 1000107, 20, 'CNY', 10.00, 'profit', 'success', 2800.00, 2810.00, 'IO202605041957471000107', 'admin', '后台强制结算发放未结算收益', '2026-05-04 21:31:12', '2026-05-04 21:31:11');
INSERT INTO `sys_user_wallet_log` VALUES (49, 1000107, 20, 'CNY', 1.20, 'invest_level_bonus', 'success', 2810.00, 2811.20, 'IO202605041957471000107', 'admin', '后台强制结算发放等级加成', '2026-05-04 21:31:12', '2026-05-04 21:31:11');
INSERT INTO `sys_user_wallet_log` VALUES (50, 1000107, 21, 'USD', 1000.00, 'invest', 'success', 3000.00, 2000.00, 'IO202605042204251000107', 'nnd1', 'APP在线签约认购', '2026-05-04 22:04:26', '2026-05-04 22:04:25');
INSERT INTO `sys_user_wallet_log` VALUES (51, 1000107, 21, 'USD', 0.10, 'other', 'success', 2000.00, 2000.10, 'WAG1777949474909442705', 'nnd1', 'WAG exchange', '2026-05-05 10:51:16', '2026-05-05 10:51:16');
INSERT INTO `sys_user_wallet_log` VALUES (52, 1000107, 21, 'USD', 0.10, 'exchange_in', 'success', 2000.10, 2000.20, 'WAG1777950204790329237', 'nnd1', 'WAG兑换', '2026-05-05 11:03:25', '2026-05-05 11:03:25');
INSERT INTO `sys_user_wallet_log` VALUES (53, 1000107, 20, 'CNY', -100.00, 'frozen', 'pending', 2811.20, 2711.20, 'WD20260505110439709092C5', 'nnd1', '提现提交并冻结金额', '2026-05-05 11:04:40', '2026-05-05 11:04:40');
INSERT INTO `sys_user_wallet_log` VALUES (54, 1000107, 20, 'CNY', 1000.00, 'invest', 'success', 2711.20, 1711.20, 'IO202605051222401000107', 'nnd1', 'APP在线签约认购', '2026-05-05 12:22:41', '2026-05-05 12:22:41');
INSERT INTO `sys_user_wallet_log` VALUES (55, 1000107, 20, 'CNY', 1000.00, 'invest', 'success', 1711.20, 711.20, 'IO202605051225181000107', 'nnd1', 'APP在线签约认购', '2026-05-05 12:25:19', '2026-05-05 12:25:18');
INSERT INTO `sys_user_wallet_log` VALUES (56, 1000100, 3, 'CNY', 1000.00, 'invest', 'success', 3500.00, 2500.00, 'IO202605051327011000100', 'lanz', 'APP在线签约认购', '2026-05-05 13:27:02', '2026-05-05 13:27:02');
INSERT INTO `sys_user_wallet_log` VALUES (57, 1000107, 20, 'CNY', 150000.00, 'recharge', 'success', 711.20, 150711.20, 'RC20260505222114156E5A28', 'admin', 'Recharge approved', '2026-05-05 22:21:27', '2026-05-05 22:21:27');
...
CREATE TABLE `sys_user_withdraw`  (
  ...
  INDEX `idx_user_currency`(`user_id` ASC, `currency_type` ASC) USING BTREE,
  INDEX `idx_status_submit_time`(`status` ASC, `submit_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户提现表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_user_withdraw` VALUES (5, 'WD20260429210352EDC579DA', 'WD20260429210352EDC579DA', 1000100, 'lanz', 'USD', 'USDT', 2, NULL, NULL, NULL, 'werewrdfsfsdfsdfdsfdsfdsfsd', 100.00, 7, 1, NULL, '2026-04-29 21:03:52', '2026-05-04 20:36:02', 1, 'admin', NULL, '', '2026-04-29 21:03:52', '', '2026-05-04 20:36:02');
INSERT INTO `sys_user_withdraw` VALUES (6, 'WD202605042032395831673C', 'W1777897951838903836282', 1000107, 'nnd1', 'CNY', 'BANK', 4, '工行', '24234234324', '李四', NULL, 200.00, 20, 1, NULL, '2026-05-04 20:32:40', '2026-05-04 20:36:34', 1, 'admin', NULL, '', '2026-05-04 20:32:40', '', '2026-05-04 20:36:34');
INSERT INTO `sys_user_withdraw` VALUES (7, 'WD20260505110439709092C5', 'W1777950246526746295331', 1000107, 'nnd1', 'CNY', 'BANK', 11, '工行', '2342423423423432', 'xtsd', NULL, 100.00, 20, 0, NULL, '2026-05-05 11:04:40', NULL, NULL, NULL, NULL, '', '2026-05-05 11:04:40', '', '2026-05-05 11:04:40');
...
CREATE TABLE `sys_yebao_config`  (
  ...
  `config_name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '配置名称',
  ...
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`config_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '余额宝配置表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_yebao_income_log`  (
  `income_id` bigint NOT NULL AUTO_INCREMENT COMMENT '收益ID',
  ...
  `shares` int NOT NULL DEFAULT 0 COMMENT '结算份数',
  ...
  `settle_days` int NOT NULL DEFAULT 0 COMMENT '结算天数',
  ...
  UNIQUE INDEX `uk_yebao_order_period`(`order_id` ASC, `period_end_time` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '余额宝收益流水表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_yebao_income_log` VALUES (3, 'YI1777996800028596b6c2b', 4, 'YB17777032462914e9c57d8', 1000107, 'nnd1', 5, 500.00, 44.0300, 4, 2.41, '2026-05-01 14:27:26', '2026-05-05 14:27:26', '2026-05-06 00:00:00', '0', 'system', '2026-05-06 00:00:00', '', NULL, 'Yebao daily settlement');
INSERT INTO `sys_yebao_income_log` VALUES (4, 'YI1777996800046078d2f9e', 3, 'YB1777619781831d8681461', 1000100, 'lanz', 3, 300.00, 44.0300, 4, 1.44, '2026-05-01 15:16:22', '2026-05-05 15:16:22', '2026-05-06 00:00:00', '0', 'system', '2026-05-06 00:00:00', '', NULL, 'Yebao daily settlement');
INSERT INTO `sys_yebao_income_log` VALUES (5, 'YI17779968000853093888e', 5, 'YB1777807481691b561adf8', 1000107, 'nnd1', 10, 1000.00, 44.0300, 4, 4.82, '2026-05-01 19:24:42', '2026-05-05 19:24:42', '2026-05-06 00:00:00', '0', 'system', '2026-05-06 00:00:00', '', NULL, 'Yebao daily settlement');
INSERT INTO `sys_yebao_income_log` VALUES (6, 'YI17779968001002813527a', 6, 'YB1777880155561fb815f26', 1000107, 'nnd1', 1, 100.00, 44.0300, 1, 0.12, '2026-05-04 15:35:56', '2026-05-05 15:35:56', '2026-05-06 00:00:00', '0', 'system', '2026-05-06 00:00:00', '', NULL, 'Yebao daily settlement');
INSERT INTO `sys_yebao_income_log` VALUES (7, 'YI1777996800113e120eeb4', 7, 'YB1777881071457311592a0', 1000107, 'nnd1', 4, 400.00, 44.0300, 1, 0.48, '2026-05-04 15:51:11', '2026-05-05 15:51:11', '2026-05-06 00:00:00', '0', 'system', '2026-05-06 00:00:00', '', NULL, 'Yebao daily settlement');
...
CREATE TABLE `sys_yebao_order`  (
  `order_id` bigint NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '订单号',
  `client_req_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '客户端请求流水（幂等）',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '用户名',
  `shares` int NOT NULL DEFAULT 0 COMMENT '购买份数',
  `unit_amount` decimal(18, 2) NOT NULL DEFAULT 100.00 COMMENT '每份金额',
  `principal_amount` decimal(18, 2) NOT NULL DEFAULT 0.00 COMMENT '本金金额',
  ...
  UNIQUE INDEX `uk_yebao_user_req`(`user_id` ASC, `client_req_no` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '余额宝订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_yebao_order
-- ----------------------------
INSERT INTO `sys_yebao_order` VALUES (1, 'YB1777607987816731ccba6', NULL, 1000100, 'lanz', 14, 100.00, 1400.00, 3.6500, 0.00, '2026-05-01 11:59:48', '2026-05-01 11:59:48', '2026-05-02 11:59:48', '1', 'lanz', '2026-05-01 11:59:48', 'lanz', '2026-05-01 12:19:24', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (2, 'YB177760889708566eae707', NULL, 1000100, 'lanz', 3, 100.00, 300.00, 44.0300, 0.00, '2026-05-01 12:14:57', '2026-05-01 12:14:57', '2026-05-02 12:14:57', '1', 'lanz', '2026-05-01 12:14:57', 'lanz', '2026-05-01 12:18:40', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (3, 'YB1777619781831d8681461', NULL, 1000100, 'lanz', 3, 100.00, 300.00, 44.0300, 2.16, '2026-05-01 15:16:22', '2026-05-05 15:16:22', '2026-05-06 15:16:22', '0', 'lanz', '2026-05-01 15:16:22', 'system', '2026-05-06 00:00:00', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (4, 'YB17777032462914e9c57d8', NULL, 1000107, 'nnd1', 5, 100.00, 500.00, 44.0300, 3.01, '2026-05-01 14:27:26', '2026-05-05 14:27:26', '2026-05-06 14:27:26', '0', 'nnd1', '2026-05-02 14:27:26', 'system', '2026-05-06 00:00:00', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (5, 'YB1777807481691b561adf8', NULL, 1000107, 'nnd1', 10, 100.00, 1000.00, 44.0300, 4.82, '2026-05-01 19:24:42', '2026-05-05 19:24:42', '2026-05-06 19:24:42', '0', 'nnd1', '2026-05-03 19:24:42', 'system', '2026-05-06 00:00:00', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (6, 'YB1777880155561fb815f26', 'YB_REQ_1777880154522957_1', 1000107, 'nnd1', 1, 100.00, 100.00, 44.0300, 0.12, '2026-05-04 15:35:56', '2026-05-05 15:35:56', '2026-05-06 15:35:56', '0', 'nnd1', '2026-05-04 15:35:56', 'system', '2026-05-06 00:00:00', 'Yebao purchase');
INSERT INTO `sys_yebao_order` VALUES (7, 'YB1777881071457311592a0', 'YB_REQ_1777881069035259_4', 1000107, 'nnd1', 4, 100.00, 400.00, 44.0300, 0.48, '2026-05-04 15:51:11', '2026-05-05 15:51:11', '2026-05-06 15:51:11', '0', 'nnd1', '2026-05-04 15:51:11', 'system', '2026-05-06 00:00:00', 'Yebao purchase');
